...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'people_animator', 'camera_operator_flag')

        # Deleting field 'Animator.csp_flag'
        db.delete_column(u'people_animator', 'csp_flag')

        # Deleting field 'Animator.age'
        db.delete_column(u'people_animator', 'age')

        # Deleting field 'Animator.village'
        db.delete_column(u'people_animator', 'village_id')

        # Deleting field 'Animator.facilitator_flag'
        db.delete_column(u'people_animator', 'facilitator_flag')

        # Deleting field 'Animator.address'
        db.delete_column(u'people_animator', 'address')

        # Deleting field 'Person.land_holdings'
        db.delete_column(u'people_person', 'land_holdings')

        # Deleting field 'Person.address'
        db.delete_column(u'people_person', 'address')

        # Deleting field 'PersonGroup.days'
        db.delete_column(u'people_persongroup', 'days')

        # Deleting field 'PersonGroup.time_updated'
        db.delete_column(u'people_persongroup', 'time_updated')

        # Deleting field 'PersonGroup.timings'
        db.delete_column(u'people_persongroup', 'timings')


    def backwards(self, orm):
        # Adding field 'Animator.camera_operator_flag'
        db.add_column(u'people_animator', 'camera_operator_flag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animator.csp_flag'
        db.add_column(u'people_animator', 'csp_flag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animator.age'
        db.add_column(u'people_animator', 'age',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animator.village'
        db.add_column(u'people_animator', 'village',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geographies.Village'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animator.facilitator_flag'
        db.add_column(u'people_animator', 'facilitator_flag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animator.address'
        db.add_column(u'people_animator', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Person.land_holdings'
        db.add_column(u'people_person', 'land_holdings',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.address'
        db.add_column(u'people_person', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'PersonGroup.days'
        db.add_column(u'people_persongroup', 'days',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PersonGroup.time_updated'
        raise RuntimeError("Cannot reverse this migration. 'PersonGroup.time_updated' and its values cannot be restored.")
        # Adding field 'PersonGroup.timings'
        db.add_column(u'people_persongroup', 'timings',
