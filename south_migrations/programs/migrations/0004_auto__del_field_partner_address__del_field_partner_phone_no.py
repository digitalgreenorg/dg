...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'programs_partner', 'address')

        # Deleting field 'Partner.phone_no'
        db.delete_column(u'programs_partner', 'phone_no')


    def backwards(self, orm):
        # Adding field 'Partner.address'
        db.add_column(u'programs_partner', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Partner.phone_no'
        db.add_column(u'programs_partner', 'phone_no',
