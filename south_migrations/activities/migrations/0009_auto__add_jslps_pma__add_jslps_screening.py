...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JSLPS_PMA'
        db.create_table(u'activities_jslps_pma', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'activities_jslps_pma_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'activities_jslps_pma_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pma_c', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.PersonMeetingAttendance'], null=True, blank=True)),
        ))
        db.send_create_signal(u'activities', ['JSLPS_PMA'])

        # Adding model 'JSLPS_Screening'
        db.create_table(u'activities_jslps_screening', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'activities_jslps_screening_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'activities_jslps_screening_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sc', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('screening', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Screening'], null=True, blank=True)),
        ))
        db.send_create_signal(u'activities', ['JSLPS_Screening'])


    def backwards(self, orm):
        # Deleting model 'JSLPS_PMA'
        db.delete_table(u'activities_jslps_pma')

        # Deleting model 'JSLPS_Screening'
        db.delete_table(u'activities_jslps_screening')
    ...
    models = {
        u'activities.jslps_pma': {
            ...
            'pma_c': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'activities.jslps_screening': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sc': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
