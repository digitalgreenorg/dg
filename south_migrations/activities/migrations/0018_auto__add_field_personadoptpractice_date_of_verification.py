...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAdoptPractice.date_of_verification'
        db.add_column(u'activities_personadoptpractice', 'date_of_verification',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAdoptPractice.date_of_verification'
        db.delete_column(u'activities_personadoptpractice', 'date_of_verification')
