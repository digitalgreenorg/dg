...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAdoptPractice.animator'
        db.add_column(u'activities_personadoptpractice', 'animator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Animator'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAdoptPractice.animator'
        db.delete_column(u'activities_personadoptpractice', 'animator_id')
