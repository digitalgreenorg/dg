...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonMeetingAttendance.interested'
        db.alter_column(u'activities_personmeetingattendance', 'interested', self.gf('django.db.models.fields.NullBooleanField')(null=True))
        # Adding field 'Screening.questions_asked'
        db.add_column(u'activities_screening', 'questions_asked',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PersonMeetingAttendance.interested'
        db.alter_column(u'activities_personmeetingattendance', 'interested', self.gf('django.db.models.fields.BooleanField')(default=None))
        # Deleting field 'Screening.questions_asked'
        db.delete_column(u'activities_screening', 'questions_asked')
