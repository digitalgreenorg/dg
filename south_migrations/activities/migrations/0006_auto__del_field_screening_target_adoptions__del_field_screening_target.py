...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'activities_screening', 'target_adoptions')

        # Deleting field 'Screening.target_person_attendance'
        db.delete_column(u'activities_screening', 'target_person_attendance')

        # Deleting field 'Screening.target_audience_interest'
        db.delete_column(u'activities_screening', 'target_audience_interest')

        # Deleting field 'PersonAdoptPractice.time_updated'
        db.delete_column(u'activities_personadoptpractice', 'time_updated')

        # Deleting field 'PersonAdoptPractice.quantity_unit'
        db.delete_column(u'activities_personadoptpractice', 'quantity_unit')

        # Deleting field 'PersonAdoptPractice.prior_adoption_flag'
        db.delete_column(u'activities_personadoptpractice', 'prior_adoption_flag')

        # Deleting field 'PersonAdoptPractice.quality'
        db.delete_column(u'activities_personadoptpractice', 'quality')

        # Deleting field 'PersonAdoptPractice.quantity'
        db.delete_column(u'activities_personadoptpractice', 'quantity')


    def backwards(self, orm):
        # Adding field 'Screening.target_adoptions'
        db.add_column(u'activities_screening', 'target_adoptions',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Screening.target_person_attendance'
        db.add_column(u'activities_screening', 'target_person_attendance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Screening.target_audience_interest'
        db.add_column(u'activities_screening', 'target_audience_interest',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAdoptPractice.time_updated'
        db.add_column(u'activities_personadoptpractice', 'time_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAdoptPractice.quantity_unit'
        db.add_column(u'activities_personadoptpractice', 'quantity_unit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'PersonAdoptPractice.prior_adoption_flag'
        db.add_column(u'activities_personadoptpractice', 'prior_adoption_flag',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAdoptPractice.quality'
        db.add_column(u'activities_personadoptpractice', 'quality',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PersonAdoptPractice.quantity'
        db.add_column(u'activities_personadoptpractice', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
