...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'District.old_coco_id'
        db.alter_column(u'geographies_district', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Region.old_coco_id'
        db.alter_column(u'geographies_region', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Block.old_coco_id'
        db.alter_column(u'geographies_block', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Village.old_coco_id'
        db.alter_column(u'geographies_village', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Country.old_coco_id'
        db.alter_column(u'geographies_country', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'State.old_coco_id'
        db.alter_column(u'geographies_state', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'District.old_coco_id'
        db.alter_column(u'geographies_district', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Region.old_coco_id'
        db.alter_column(u'geographies_region', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Block.old_coco_id'
        db.alter_column(u'geographies_block', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Village.old_coco_id'
        db.alter_column(u'geographies_village', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Country.old_coco_id'
        db.alter_column(u'geographies_country', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'State.old_coco_id'
        db.alter_column(u'geographies_state', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))
