...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServerLog.instance_json'
        db.add_column('dashboard_serverlog', 'instance_json',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServerLog.instance_json'
        db.delete_column('dashboard_serverlog', 'instance_json')
