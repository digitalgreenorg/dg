...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_cocouser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('partner', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Partners'])),
        ))
        db.send_create_signal('dashboard', ['CocoUser'])

        # Adding M2M table for field villages on 'CocoUser'
        db.create_table('dashboard_cocouser_villages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cocouser', models.ForeignKey(orm['dashboard.cocouser'], null=False)),
            ('village', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'], null=False))
        ))
        db.create_unique('dashboard_cocouser_villages', ['cocouser_id', 'village_id'])


    def backwards(self, orm):
        # Deleting model 'CocoUser'
        db.delete_table('dashboard_cocouser')

        # Removing M2M table for field villages on 'CocoUser'
        db.delete_table('dashboard_cocouser_villages')
