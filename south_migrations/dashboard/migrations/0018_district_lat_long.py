...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        geocoder = Geocoder()
        for d in orm['dashboard.District'].objects.all():
            ...
            if (geocoder.convert(address)):
                try:
                    ...
                    logger.error("Geocodes not found for %s, %s" % (d.district_name, d.state.state_name))
        logger.info("Geocodes generated for all Districts")
