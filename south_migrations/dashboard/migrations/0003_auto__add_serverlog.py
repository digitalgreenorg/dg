...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_serverlog', (
            ...
            ('village', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('action', self.gf('django.db.models.fields.IntegerField')()),
            ('entry_table', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('model_id', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('partner', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
        ))
