...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoComment.personName'
        db.add_column(u'videokheti_videocomment', 'personName',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoComment.personName'
        db.delete_column(u'videokheti_videocomment', 'personName')
