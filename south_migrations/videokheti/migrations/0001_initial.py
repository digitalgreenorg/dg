...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Crop'
        db.create_table(u'videokheti_crop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('image_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sound_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videokheti', ['Crop'])

        # Adding model 'TimeYear'
        db.create_table(u'videokheti_timeyear', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('image_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sound_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videokheti', ['TimeYear'])

        # Adding model 'ActionType'
        db.create_table(u'videokheti_actiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('image_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sound_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('time_year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.TimeYear'])),
        ))
        db.send_create_signal(u'videokheti', ['ActionType'])

        # Adding model 'Method'
        db.create_table(u'videokheti_method', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('image_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sound_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videokheti', ['Method'])

        # Adding model 'Video'
        db.create_table(u'videokheti_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coco_video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
            ('website_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('crop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.Crop'])),
            ('time_year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.TimeYear'])),
            ('action_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.ActionType'], null=True, blank=True)),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.Method'], null=True, blank=True)),
            ('image_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sound_file', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videokheti', ['Video'])


    def backwards(self, orm):
        # Deleting model 'Crop'
        db.delete_table(u'videokheti_crop')

        # Deleting model 'TimeYear'
        db.delete_table(u'videokheti_timeyear')

        # Deleting model 'ActionType'
        db.delete_table(u'videokheti_actiontype')

        # Deleting model 'Method'
        db.delete_table(u'videokheti_method')

        # Deleting model 'Video'
        db.delete_table(u'videokheti_video')
