...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videokheti_videocomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 1, 23, 0, 0))),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videokheti.Video'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('imageURL', self.gf('django.db.models.fields.URLField')(max_length=400, null=True, blank=True)),
        ))
        db.send_create_signal(u'videokheti', ['VideoComment'])


    def backwards(self, orm):
        # Deleting model 'VideoComment'
        db.delete_table(u'videokheti_videocomment')
    ...
    models = {
        ...
        u'videokheti.videocomment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
