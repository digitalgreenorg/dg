...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Title'
        db.create_table(u'videokheti_title', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('table', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('hindi_text', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal(u'videokheti', ['Title'])


    def backwards(self, orm):
        # Deleting model 'Title'
        db.delete_table(u'videokheti_title')
    ...
    models = {
        ...
        u'videokheti.title': {
            ...
            'hindi_text': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'table': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
