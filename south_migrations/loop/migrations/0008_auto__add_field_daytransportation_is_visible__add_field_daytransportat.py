...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DayTransportation.is_visible'
        db.add_column(u'loop_daytransportation', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DayTransportation.timestamp'
        db.add_column(u'loop_daytransportation', 'timestamp',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=25),
                      keep_default=False)

        # Adding field 'CombinedTransaction.is_visible'
        db.add_column(u'loop_combinedtransaction', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CombinedTransaction.payment_date'
        db.add_column(u'loop_combinedtransaction', 'payment_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CombinedTransaction.timestamp'
        db.alter_column(u'loop_combinedtransaction', 'timestamp', self.gf('django.db.models.fields.CharField')(default='test', max_length=25))

    def backwards(self, orm):
        # Deleting field 'DayTransportation.is_visible'
        db.delete_column(u'loop_daytransportation', 'is_visible')

        # Deleting field 'DayTransportation.timestamp'
        db.delete_column(u'loop_daytransportation', 'timestamp')

        # Deleting field 'CombinedTransaction.is_visible'
        db.delete_column(u'loop_combinedtransaction', 'is_visible')

        # Deleting field 'CombinedTransaction.payment_date'
        db.delete_column(u'loop_combinedtransaction', 'payment_date')


        # Changing field 'CombinedTransaction.timestamp'
        db.alter_column(u'loop_combinedtransaction', 'timestamp', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
