...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DayTransportation', fields ['date', 'user_created', 'timestamp']
        db.create_unique(u'loop_daytransportation', ['date', 'user_created_id', 'timestamp'])


    def backwards(self, orm):
        # Removing unique constraint on 'DayTransportation', fields ['date', 'user_created', 'timestamp']
        db.delete_unique(u'loop_daytransportation', ['date', 'user_created_id', 'timestamp'])
    ...
    models = {
        ...
        u'loop.daytransportation': {
            'Meta': {'unique_together': "(('date', 'user_created', 'timestamp'),)", 'object_name': 'DayTransportation'},
