...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransportationVehicle.vehicle_number'
        db.alter_column(u'loop_transportationvehicle', 'vehicle_number', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'TransportationVehicle.vehicle_number'
        db.alter_column(u'loop_transportationvehicle', 'vehicle_number', self.gf('django.db.models.fields.CharField')(max_length=11))
