...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field videos on 'CocoUser'
        db.create_table(u'coco_cocouser_videos', (
        ...
        db.create_unique(u'coco_cocouser_videos', ['cocouser_id', 'video_id'])


    def backwards(self, orm):
        # Removing M2M table for field videos on 'CocoUser'
        db.delete_table('coco_cocouser_videos')
