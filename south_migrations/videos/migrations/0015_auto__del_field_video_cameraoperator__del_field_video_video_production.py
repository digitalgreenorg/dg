...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.cameraoperator'
        db.delete_column(u'videos_video', 'cameraoperator_id')

        # Deleting field 'Video.video_production_start_date'
        db.delete_column(u'videos_video', 'video_production_start_date')

        # Deleting field 'Video.facilitator'
        db.delete_column(u'videos_video', 'facilitator_id')

        # Adding unique constraint on 'Video', fields ['title', 'production_date', 'language', 'village']
        db.create_unique(u'videos_video', ['title', 'production_date', 'language_id', 'village_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Video', fields ['title', 'production_date', 'language', 'village']
        db.delete_unique(u'videos_video', ['title', 'production_date', 'language_id', 'village_id'])

        # Adding field 'Video.cameraoperator'
        db.add_column(u'videos_video', 'cameraoperator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='cameraoperator', to=orm['people.Animator']),
                      keep_default=False)

        # Adding field 'Video.video_production_start_date'
        db.add_column(u'videos_video', 'video_production_start_date',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'Video.facilitator'
        db.add_column(u'videos_video', 'facilitator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='facilitator', to=orm['people.Animator']),
                      keep_default=False)
