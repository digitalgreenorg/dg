...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videos_videopractice', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_videopractice_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_videopractice_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subcategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubCategory'])),
            ('videopractice_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videos', ['VideoPractice'])

        # Adding field 'Video.videopractice'
        db.add_column(u'videos_video', 'videopractice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.VideoPractice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VideoPractice'
        db.delete_table(u'videos_videopractice')

        # Deleting field 'Video.videopractice'
        db.delete_column(u'videos_video', 'videopractice_id')
