...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.video_production_end_date'
        db.delete_column(u'videos_video', 'video_production_end_date')


    def backwards(self, orm):
        # Adding field 'Video.video_production_end_date'
        db.add_column(u'videos_video', 'video_production_end_date',
