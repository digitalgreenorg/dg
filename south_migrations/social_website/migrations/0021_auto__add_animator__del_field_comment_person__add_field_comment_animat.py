...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_website_animator', (
        ...
        db.send_create_signal(u'social_website', ['Animator'])

        # Deleting field 'Comment.person'
        db.delete_column(u'social_website_comment', 'person_id')

        # Adding field 'Comment.animator'
        db.add_column(u'social_website_comment', 'animator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_website.Animator'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Animator'
        db.delete_table(u'social_website_animator')

        # Adding field 'Comment.person'
        db.add_column(u'social_website_comment', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_website.Person'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.animator'
        db.delete_column(u'social_website_comment', 'animator_id')
    ...
    models = {
        ...
        u'social_website.animator': {
            'Meta': {'object_name': 'Animator'},
        ...
        u'social_website.comment': {
            ...
            'animator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social_website.Animator']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 9, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 9, 0, 0)'}),
