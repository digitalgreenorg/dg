...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.offlineLikes'
        db.delete_column(u'social_website_video', 'offlineLikes')


    def backwards(self, orm):
        # Adding field 'Video.offlineLikes'
        db.add_column(u'social_website_video', 'offlineLikes',
    ...
    models = {
        ...
        u'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 27, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 27, 0, 0)'}),
