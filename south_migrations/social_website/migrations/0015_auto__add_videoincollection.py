...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VideoinCollection'
        db.create_table('social_website_videoincollection', (
        ...
        db.send_create_signal('social_website', ['VideoinCollection'])


    def backwards(self, orm):
        # Deleting model 'VideoinCollection'
        db.delete_table('social_website_videoincollection')
