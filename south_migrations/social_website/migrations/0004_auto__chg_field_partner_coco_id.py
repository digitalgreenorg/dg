...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partner.coco_id'
        db.alter_column('social_website_partner', 'coco_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Partner.coco_id'
        db.alter_column('social_website_partner', 'coco_id', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
