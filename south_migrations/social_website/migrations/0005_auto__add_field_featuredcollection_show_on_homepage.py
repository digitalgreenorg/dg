...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedCollection.show_on_homepage'
        db.add_column('social_website_featuredcollection', 'show_on_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FeaturedCollection.show_on_language_selection'
        db.add_column('social_website_featuredcollection', 'show_on_language_selection',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'FeaturedCollection.collageURL'
        db.alter_column('social_website_featuredcollection', 'collageURL', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Partner.logoURL'
        db.alter_column('social_website_partner', 'logoURL', self.gf('django.db.models.fields.files.ImageField')(default=' ', max_length=100))
        # Adding unique constraint on 'Partner', fields ['name']
        db.create_unique('social_website_partner', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Partner', fields ['name']
        db.delete_unique('social_website_partner', ['name'])

        # Deleting model 'CronTimestamp'
        db.delete_table('social_website_crontimestamp')

        # Deleting field 'FeaturedCollection.show_on_homepage'
        db.delete_column('social_website_featuredcollection', 'show_on_homepage')

        # Deleting field 'FeaturedCollection.show_on_language_selection'
        db.delete_column('social_website_featuredcollection', 'show_on_language_selection')


        # Changing field 'FeaturedCollection.collageURL'
        db.alter_column('social_website_featuredcollection', 'collageURL', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)'}),
        ...
        'social_website.crontimestamp': {
            ...
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)'}),
