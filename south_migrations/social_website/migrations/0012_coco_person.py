...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        coco_person = orm['people.Person']
        website_person = orm['social_website.Person']

        for person in website_person.objects.all():
            try:
                person.coco_id = coco_person.objects.get(old_coco_id=person.coco_id).id
                person.save()
            except:
                print person.uid
    ...
    complete_apps = ['people', 'social_website']
    symmetrical = True
