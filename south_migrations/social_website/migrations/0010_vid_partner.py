...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for vid in orm['social_website.video'].objects.all():
            try:
                coco_vid = orm['dashboard.video'].objects.get(id=vid.coco_id)
                vid.partner = orm['social_website.partner'].objects.get(coco_id = str(coco_vid.partner.id))
                vid.save()
            except:
                print vid.title
    ...
    models = {
        ...
        u'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
