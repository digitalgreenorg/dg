...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_website_resourcevideo', (
            ('uid', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('youtubeID', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('videoTag', self.gf('django.db.models.fields.CharField')(default='f', max_length=2)),
        ))
        db.send_create_signal(u'social_website', ['ResourceVideo'])


    def backwards(self, orm):
        # Deleting model 'ResourceVideo'
        db.delete_table(u'social_website_resourcevideo')
    ...
    models = {
        ...
        u'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 9, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 9, 0, 0)'}),
