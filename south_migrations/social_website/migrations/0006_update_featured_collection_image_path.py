...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        featured_collections = orm['social_website.FeaturedCollection'].objects.all()
        for featured_collection in featured_collections:
            featured_collection.collageURL = ("featured_collection/%s" % (featured_collection.collageURL.url.split('/'))[-1])
