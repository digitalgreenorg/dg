...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        website_video = orm['social_website.Video']

        s3_url_raw = "http://s3.amazonaws.com/digitalgreen/video_thumbnail/raw/"
        s3_url_16by9 = "http://s3.amazonaws.com/digitalgreen/video_thumbnail/16by9/"
        for video in website_video.objects.all():
            try:
                video.thumbnailURL = "".join([s3_url_raw, video.coco_id, ".jpg"])
                video.thumbnailURL16by9 = "".join([s3_url_16by9, video.coco_id, ".jpg"])
                video.save()
            except:
                print video.uid
    ...
    models = {
        ...
        u'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
