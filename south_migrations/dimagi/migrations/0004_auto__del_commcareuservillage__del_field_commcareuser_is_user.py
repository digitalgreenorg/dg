...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommCareUser.is_user'
        db.delete_column(u'dimagi_commcareuser', 'is_user')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CommCareUser.is_user'
        db.add_column(u'dimagi_commcareuser', 'is_user',
