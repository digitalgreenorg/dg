...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommCareProject.group_name'
        db.add_column(u'dimagi_commcareproject', 'group_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommCareProject.group_id'
        db.add_column(u'dimagi_commcareproject', 'group_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommCareProject.group_name'
        db.delete_column(u'dimagi_commcareproject', 'group_name')

        # Deleting field 'CommCareProject.group_id'
        db.delete_column(u'dimagi_commcareproject', 'group_id')
