...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommCareUser.coco_user'
        db.add_column(u'dimagi_commcareuser', 'coco_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['coco.CocoUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommCareUser.coco_user'
        db.delete_column(u'dimagi_commcareuser', 'coco_user_id')
