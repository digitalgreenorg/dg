...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dimagi_xmlsubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission_time', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dimagi', ['XMLSubmission'])

        # Adding model 'CommCareProject'
        db.create_table(u'dimagi_commcareproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
            ('last_updated_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow)),
        ))
        db.send_create_signal(u'dimagi', ['CommCareProject'])

        # Adding model 'CommCareUser'
        db.create_table(u'dimagi_commcareuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dimagi.CommCareProject'])),
            ('is_user', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'dimagi', ['CommCareUser'])

        # Adding unique constraint on 'CommCareUser', fields ['project', 'username']
        db.create_unique(u'dimagi_commcareuser', ['project_id', 'username'])

        # Adding model 'CommCareUserVillage'
        db.create_table(u'dimagi_commcareuservillage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('village', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geographies.Village'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dimagi.CommCareUser'])),
        ))
        db.send_create_signal(u'dimagi', ['CommCareUserVillage'])

        # Adding model 'CommCareCase'
        db.create_table(u'dimagi_commcarecase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'dimagi', ['CommCareCase'])

        # Adding unique constraint on 'CommCareCase', fields ['is_open', 'person', 'project', 'user']
        db.create_unique(u'dimagi_commcarecase', ['is_open', 'person_id', 'project_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CommCareCase', fields ['is_open', 'person', 'project', 'user']
        db.delete_unique(u'dimagi_commcarecase', ['is_open', 'person_id', 'project_id', 'user_id'])

        # Removing unique constraint on 'CommCareUser', fields ['project', 'username']
        db.delete_unique(u'dimagi_commcareuser', ['project_id', 'username'])

        # Deleting model 'XMLSubmission'
        db.delete_table(u'dimagi_xmlsubmission')

        # Deleting model 'CommCareProject'
        db.delete_table(u'dimagi_commcareproject')

        # Deleting model 'CommCareUser'
        db.delete_table(u'dimagi_commcareuser')

        # Deleting model 'CommCareUserVillage'
        db.delete_table(u'dimagi_commcareuservillage')

        # Deleting model 'CommCareCase'
        db.delete_table(u'dimagi_commcarecase')
    ...
    models = {
        ...
        u'dimagi.commcarecase': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dimagi.CommCareProject']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dimagi.CommCareUser']"})
        },
        u'dimagi.commcareproject': {
        ...
        u'dimagi.commcareuser': {
            'Meta': {'unique_together': "(('project', 'username'),)", 'object_name': 'CommCareUser'},
            'assigned_villages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['geographies.Village']", 'through': u"orm['dimagi.CommCareUserVillage']", 'symmetrical': 'False'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
