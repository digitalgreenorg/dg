...
class Command(BaseCommand):
	def handle(self, *args, **options):
		...
		csv_file = open('jslps_data_integration_files/jslps-hnn-person-new5.csv', 'wb')
		wtr = csv.writer(csv_file, quoting=csv.QUOTE_ALL)
		tree = ET.parse('jslps_data_integration_files/jslps-hnn-person-new5.xml')
		root = tree.getroot()
		
		for c in root.findall('GroupMemberDataNew5'):
