...
class Command(BaseCommand):
    ...
    def send_mail(self):
        ...
        to_email = ['vikas@digitalgreen.org']#['aditya@digitalgreen.org', 'vivek@digitalgreen.org', 'vikas@digitalgreen.org', 'abhishekchandran@digitalgreen.org', 'joshin@digitalgreen.org', 'shetty@digitalgreen.org', 'ritesh@digitalgreen.org', 'charu@digitalgreen.org']
