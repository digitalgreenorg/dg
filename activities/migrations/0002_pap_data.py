...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        Pap = orm['activities.PersonAdoptPractice']
        chunk = 1000
        ...
        for i in range(0, dashboard_pap.count()/chunk + 1):
            ...
            Pap.objects.bulk_create([Pap(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
                                         old_coco_id=x.id, person=orm['people.Person'].objects.get(old_coco_id=x.person_id),
