    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adoption_confidence', models.CharField(help_text=b'Does the farmer feel confident in adopting the practice?', max_length=20, choices=[(b'yes', b'Yes'), (b'no', b'No')])),
                ...
                ('time_convenience', models.CharField(help_text=b'Was the screening time convenient?', max_length=20, choices=[(b'yes', b'Yes'), (b'no', b'No')])),
                ...
                ('additional_challenges_encountered', models.CharField(help_text=b'Do you face any additional challenges in attending video dissemination sessions other than time and location?', max_length=20, choices=[(b'yes', b'Yes'), (b'no', b'No')])),
                ...
                ('comfortable_asking', models.CharField(help_text=b'Did the farmer feel comfortable asking questions and participating?', max_length=20, choices=[(b'yes', b'Yes'), (b'no', b'No')])),
