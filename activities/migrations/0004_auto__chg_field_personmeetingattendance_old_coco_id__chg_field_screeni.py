...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonMeetingAttendance.old_coco_id'
        db.alter_column(u'activities_personmeetingattendance', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Screening.old_coco_id'
        db.alter_column(u'activities_screening', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PersonAdoptPractice.old_coco_id'
        db.alter_column(u'activities_personadoptpractice', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PersonMeetingAttendance.old_coco_id'
        db.alter_column(u'activities_personmeetingattendance', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Screening.old_coco_id'
        db.alter_column(u'activities_screening', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PersonAdoptPractice.old_coco_id'
        db.alter_column(u'activities_personadoptpractice', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))
