...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'activities_personadoptpractice', 'verification_status',
                      self.gf('django.db.models.fields.IntegerField')(default=3, max_length=1),
                      keep_default=False)
    ...
    models = {
        u'activities.personadoptpractice': {
            ...
            'verification_status': ('django.db.models.fields.IntegerField', [], {'default': '3', 'max_length': '1'}),
            'verified_by': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
