...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAdoptPractice.verified'
        db.add_column(u'activities_personadoptpractice', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAdoptPractice.verified'
        db.delete_column(u'activities_personadoptpractice', 'verified')
