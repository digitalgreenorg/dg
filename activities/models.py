...
class PersonAdoptPractice(CocoModel):
    ...
    def __unicode__(self):
        return "%s (%s) (%s) (%s) (%s)" % (self.person.person_name, self.person.father_name, self.person.group.group_name if self.person.group else 'yoyo', self.person.village.village_name, self.video.title)
