    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(default=None, blank=True, to='loop.LoopUser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=0, db_index=True, choices=[(0, b'Pending'), (1, b'Done'), (2, b'DND-Failed')])),
                ('start_time', models.DateTimeField(null=True, blank=True)),
                ('end_time', models.DateTimeField(null=True, blank=True)),
                ('broadcast', models.ForeignKey(default=None, blank=True, to='loop.Broadcast')),
                ('farmer', models.ForeignKey(default=None, blank=True, to='loop.Farmer')),
