...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Gaddidar', fields ['phone', 'name']
        db.delete_unique(u'loop_gaddidar', ['phone', 'name'])

        # Adding field 'Gaddidar.gaddidar_name'
        db.add_column(u'loop_gaddidar', 'gaddidar_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Gaddidar.gaddidar_phone'
        db.add_column(u'loop_gaddidar', 'gaddidar_phone',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=13, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Gaddidar.gaddidar_name'
        db.delete_column(u'loop_gaddidar', 'gaddidar_name')

        # Deleting field 'Gaddidar.gaddidar_phone'
        db.delete_column(u'loop_gaddidar', 'gaddidar_phone')

        # Adding unique constraint on 'Gaddidar', fields ['phone', 'name']
        db.create_unique(u'loop_gaddidar', ['phone', 'name'])
    ...
    models = {
        ...
        u'loop.gaddidar': {
            ...
            'gaddidar_name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
            'gaddidar_phone': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '13', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mandi': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['loop.Mandi']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
