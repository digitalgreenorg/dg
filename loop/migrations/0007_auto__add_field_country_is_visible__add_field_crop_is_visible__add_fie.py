...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoopUserAssignedMandi.is_visible'
        db.add_column(u'loop_loopuserassignedmandi', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LoopUserAssignedMandi.is_visible'
        db.delete_column(u'loop_loopuserassignedmandi', 'is_visible')
