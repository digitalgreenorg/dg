...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Gaddidar'
        db.create_table(u'loop_gaddidar', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_gaddidar_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_gaddidar_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gaddidar_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('gaddidar_phone', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('commission', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('mandi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.Mandi'])),
        ))
        db.send_create_signal(u'loop', ['Gaddidar'])
        ...
        db.create_table(u'loop_daytransportation', (
            ...
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_daytransportation_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('transportation_vehicle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.TransportationVehicle'])),
            ('transportation_cost', self.gf('django.db.models.fields.FloatField')()),
            ('farmer_share', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('other_cost', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('vrp_fees', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('mandi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.Mandi'])),
        ))
        db.send_create_signal(u'loop', ['DayTransportation'])

        # Adding model 'TransportationVehicle'
        db.create_table(u'loop_transportationvehicle', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_transportationvehicle_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_transportationvehicle_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.Transporter'])),
            ('vehicle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.Vehicle'])),
            ('vehicle_number', self.gf('django.db.models.fields.CharField')(max_length=11)),
        ))
        db.send_create_signal(u'loop', ['TransportationVehicle'])

        # Adding unique constraint on 'TransportationVehicle', fields ['transporter', 'vehicle', 'vehicle_number']
        db.create_unique(u'loop_transportationvehicle', ['transporter_id', 'vehicle_id', 'vehicle_number'])

        # Adding model 'Transporter'
        db.create_table(u'loop_transporter', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_transporter_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'loop_transporter_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transporter_name', self.gf('django.db.models.fields.CharField')(max_length=90)),
            ('transporter_phone', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loop.Block'])),
        ))
        db.send_create_signal(u'loop', ['Transporter'])
        ...
        db.add_column(u'loop_loopuser', 'village',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['loop.Village'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TransportationVehicle'
        db.delete_table(u'loop_transportationvehicle')
    ...
    models = {
        ...
        u'loop.loopuser': {
            ...
            'assigned_mandis': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'assigned_mandis'", 'symmetrical': 'False', 'to': u"orm['loop.Mandi']"}),
        ...
        u'loop.transportationvehicle': {
            ...
            'vehicle_number': ('django.db.models.fields.CharField', [], {'max_length': '11'})
        },
        u'loop.transporter': {
