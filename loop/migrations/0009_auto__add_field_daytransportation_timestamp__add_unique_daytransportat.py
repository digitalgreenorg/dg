...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DayTransportation', fields ['date', 'timestamp', 'user_created']
        db.create_unique(u'loop_daytransportation', ['date', 'timestamp', 'user_created_id'])

        # Adding unique constraint on 'CombinedTransaction', fields ['date', 'timestamp', 'user_created']
        db.create_unique(u'loop_combinedtransaction', ['date', 'timestamp', 'user_created_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CombinedTransaction', fields ['date', 'timestamp', 'user_created']
        db.delete_unique(u'loop_combinedtransaction', ['date', 'timestamp', 'user_created_id'])

        # Removing unique constraint on 'DayTransportation', fields ['date', 'timestamp', 'user_created']
        db.delete_unique(u'loop_daytransportation', ['date', 'timestamp', 'user_created_id'])
    ...
    models = {
        ...
        u'loop.combinedtransaction': {
            'Meta': {'unique_together': "(('date', 'timestamp', 'user_created'),)", 'object_name': 'CombinedTransaction'},
        ...
        u'loop.daytransportation': {
            'Meta': {'unique_together': "(('date', 'timestamp', 'user_created'),)", 'object_name': 'DayTransportation'},
