...
class Command(BaseCommand):
    ...
    def send_mail(self,total_pending_call_count,
        ...
        email_body = ['<html><body>',
                    ...
                    '<table>',
                    '<td><tr>Total Pending Calls Till Now:<tr></tr> %s</tr><td>'%(total_pending_call_count,),
                    '<td><tr>Total Received Calls on %s:<tr></tr> %s</tr><td>'%(yesterday_date,yesterday_received_call_count),
                    '<td><tr>Total Attended Calls on %s:<tr></tr> %s</tr><td>'%(yesterday_date,yesterday_resolved_call_count),
                    '<td><tr>Total Declined Calls Till now:<tr></tr> %s</tr><td>'%(total_declined_call_count,),
                    '<td><tr>Total Declined Calls on %s:<tr></tr> %s</tr><td>'%(yesterday_date,yesterday_declined_call_count),
                    '<td><tr>Total Received Calls During Off Hours i.e. 6:00 PM, %s to 9:00 AM, %s:<tr></tr> %s</tr><td>'%(yesterday_date,today_date,yesterday_off_hours_incoming_call_count),
                    '</table>',
