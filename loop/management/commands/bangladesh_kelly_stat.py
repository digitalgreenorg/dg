...
class Command(BaseCommand):
    ...
    def send_mail(self,gender_wise_farmer):
        ...
        body = ['Dear Team,\n\nBelow is the genderwise counting of farmers who have used the LOOP platform at least once in Bangladesh.\n\n',
                'Common Active farmer who participated and YEAR 1 as well as YEAR 2:\n\tNo of Female Farmers: %s\n\tNo of Male Farmers: %s\n\n'%(gender_wise_farmer['F'][0], gender_wise_farmer['M'][1]),
                'New Farmer who participated in YEAR 2 but not in YEAR 1:\n\tNo of Female Farmers: %s\n\tNo of Male Farmers: %s\n\n'%(gender_wise_farmer['F'][1],gender_wise_farmer['M'][1]),
