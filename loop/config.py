...
registration_sms = {
  'welcome':{'hi':u'अगर आप लूप किसान हैं,तो "1" लिख कर 9246022444 पर SMS भेजें और पहली बार अपनी सब्ज़ी मंडी तक मुफ़्त पहुँचायें।','en':u'Welcome to Loop! Please reply "1" to confirm and receive your free transport credit'},
...
first_transaction_sms ={'hi':u'नये किसान लूप से जोड़ें और उनके लूप के पहले इस्तेमाल पर आप अपना अगला लूप गाड़ी भाड़ा मुफ्त पाएं।एग्रीगेटर को नये किसान का मोबाइल नः दें।','en':'thanks'}

referral_transport_sms = {
  'beg':{'hi':u'साथी किसान को लूप से जोड़ने के लिए धन्यवाद| एग्रीगेटर को ','en':u'beg'},
  'end':{'hi':u' कोड दें और अगली बार अपनी सब्ज़ी लूप कि गाड़ी से मंडी मुफ़्त पहुँचायें|','en':u'end'}
}
already_exist_sms = {
