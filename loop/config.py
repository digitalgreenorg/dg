...
header_dict_for_loop_email_mobile_numbers = {
     'workbook_name_all': '%s/loop/Incorrect mobile numbers of all aggregators.xlsx'%(MEDIA_ROOT,),
     'workbook_name_specific': 'Incorrect mobile numbers of a specific aggregator.xlsx',
