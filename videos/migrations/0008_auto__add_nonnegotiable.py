...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NonNegotiable'
        db.create_table(u'videos_nonnegotiable', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_nonnegotiable_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_nonnegotiable_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('non_negotiable', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
        ))
        db.send_create_signal(u'videos', ['NonNegotiable'])


    def backwards(self, orm):
        # Deleting model 'NonNegotiable'
        db.delete_table(u'videos_nonnegotiable')
