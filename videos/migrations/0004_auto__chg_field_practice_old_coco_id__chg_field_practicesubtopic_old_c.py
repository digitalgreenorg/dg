...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.old_coco_id'
        db.alter_column(u'videos_practice', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PracticeSubtopic.old_coco_id'
        db.alter_column(u'videos_practicesubtopic', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PracticeSector.old_coco_id'
        db.alter_column(u'videos_practicesector', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PracticeTopic.old_coco_id'
        db.alter_column(u'videos_practicetopic', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PracticeSubject.old_coco_id'
        db.alter_column(u'videos_practicesubject', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Video.old_coco_id'
        db.alter_column(u'videos_video', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PracticeSubSector.old_coco_id'
        db.alter_column(u'videos_practicesubsector', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Practice.old_coco_id'
        db.alter_column(u'videos_practice', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PracticeSubtopic.old_coco_id'
        db.alter_column(u'videos_practicesubtopic', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PracticeSector.old_coco_id'
        db.alter_column(u'videos_practicesector', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PracticeTopic.old_coco_id'
        db.alter_column(u'videos_practicetopic', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PracticeSubject.old_coco_id'
        db.alter_column(u'videos_practicesubject', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Video.old_coco_id'
        db.alter_column(u'videos_video', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'PracticeSubSector.old_coco_id'
        db.alter_column(u'videos_practicesubsector', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))
