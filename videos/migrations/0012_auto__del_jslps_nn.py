...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'videos_jslps_nn', (
            ...
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'videos_jslps_nn_created', null=True, to=orm['auth.User'], blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'videos_jslps_nn_related_modified', null=True, to=orm['auth.User'], blank=True)),
