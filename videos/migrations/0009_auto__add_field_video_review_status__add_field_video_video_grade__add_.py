...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.review_status'
        db.add_column(u'videos_video', 'review_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'Video.video_grade'
        db.add_column(u'videos_video', 'video_grade',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'videos_video', 'review_status')
