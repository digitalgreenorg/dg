...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NonNegotiable.physically_verifiable'
        db.add_column(u'videos_nonnegotiable', 'physically_verifiable',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NonNegotiable.physically_verifiable'
        db.delete_column(u'videos_nonnegotiable', 'physically_verifiable')
