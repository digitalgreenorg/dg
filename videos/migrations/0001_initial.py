...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videos_practicesector', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesector_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesector_related_modified', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'videos', ['PracticeSector'])

        # Adding model 'PracticeSubSector'
        db.create_table(u'videos_practicesubsector', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubsector_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubsector_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'videos', ['PracticeSubSector'])

        # Adding model 'PracticeTopic'
        db.create_table(u'videos_practicetopic', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicetopic_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicetopic_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'videos', ['PracticeTopic'])

        # Adding model 'PracticeSubtopic'
        db.create_table(u'videos_practicesubtopic', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubtopic_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubtopic_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'videos', ['PracticeSubtopic'])

        # Adding model 'PracticeSubject'
        db.create_table(u'videos_practicesubject', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubject_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practicesubject_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'videos', ['PracticeSubject'])

        # Adding model 'Practice'
        db.create_table(u'videos_practice', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practice_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_practice_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('practice_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('practice_sector', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['videos.PracticeSector'])),
            ('practice_subsector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.PracticeSubSector'], null=True, blank=True)),
            ('practice_topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.PracticeTopic'], null=True, blank=True)),
            ('practice_subtopic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.PracticeSubtopic'], null=True, blank=True)),
            ('practice_subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.PracticeSubject'], null=True, blank=True)),
        ))
        db.send_create_signal(u'videos', ['Practice'])

        # Adding unique constraint on 'Practice', fields ['practice_sector', 'practice_subsector', 'practice_topic', 'practice_subtopic', 'practice_subject']
        db.create_unique(u'videos_practice', ['practice_sector_id', 'practice_subsector_id', 'practice_topic_id', 'practice_subtopic_id', 'practice_subject_id'])

        # Adding model 'Language'
        db.create_table(u'videos_language', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_language_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_language_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
        ))
        db.send_create_signal(u'videos', ['Language'])

        # Adding model 'Video'
        db.create_table(u'videos_video', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_video_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_video_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ...
            ('supplementary_video_produced', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True, blank=True)),
            ...
            ('related_practice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Practice'], null=True, blank=True)),
        ...
        db.create_unique(u'videos_video', ['title', 'video_production_start_date', 'video_production_end_date', 'village_id'])

        # Adding M2M table for field farmers_shown on 'Video'
        db.create_table(u'videos_video_farmers_shown', (
        ...
        db.create_unique(u'videos_video_farmers_shown', ['video_id', 'person_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Video', fields ['title', 'video_production_start_date', 'video_production_end_date', 'village']
        db.delete_unique(u'videos_video', ['title', 'video_production_start_date', 'video_production_end_date', 'village_id'])

        # Removing unique constraint on 'Practice', fields ['practice_sector', 'practice_subsector', 'practice_topic', 'practice_subtopic', 'practice_subject']
        db.delete_unique(u'videos_practice', ['practice_sector_id', 'practice_subsector_id', 'practice_topic_id', 'practice_subtopic_id', 'practice_subject_id'])

        # Deleting model 'PracticeSector'
        db.delete_table(u'videos_practicesector')

        # Deleting model 'PracticeSubSector'
        db.delete_table(u'videos_practicesubsector')

        # Deleting model 'PracticeTopic'
        db.delete_table(u'videos_practicetopic')

        # Deleting model 'PracticeSubtopic'
        db.delete_table(u'videos_practicesubtopic')

        # Deleting model 'PracticeSubject'
        db.delete_table(u'videos_practicesubject')

        # Deleting model 'Practice'
        db.delete_table(u'videos_practice')

        # Deleting model 'Language'
        db.delete_table(u'videos_language')

        # Deleting model 'Video'
        db.delete_table(u'videos_video')

        # Removing M2M table for field farmers_shown on 'Video'
        db.delete_table('videos_video_farmers_shown')
