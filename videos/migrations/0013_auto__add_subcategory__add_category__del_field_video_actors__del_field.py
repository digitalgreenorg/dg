...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videos_subcategory', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_subcategory_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_subcategory_related_modified', null=True, to=orm['auth.User'])),
            ...
            ('subcategory_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'videos', ['SubCategory'])

        # Adding model 'Category'
        db.create_table(u'videos_category', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_category_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_category_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category_name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
        ))
        db.send_create_signal(u'videos', ['Category'])

        # Deleting field 'Video.actors'
        db.delete_column(u'videos_video', 'actors')
        ...
        # Adding M2M table for field production_team on 'Video'
        m2m_table_name = db.shorten_name(u'videos_video_production_team')
        ...
        db.create_unique(m2m_table_name, ['video_id', 'animator_id'])


    def backwards(self, orm):
        # Deleting model 'SubCategory'
        db.delete_table(u'videos_subcategory')

        # Deleting model 'Category'
        db.delete_table(u'videos_category')

        # Adding field 'Video.actors'
        db.add_column(u'videos_video', 'actors',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=1),
                      keep_default=False)

        # Adding field 'Video.video_suitable_for'
        db.add_column(u'videos_video', 'video_suitable_for',
        ...
        # Removing M2M table for field production_team on 'Video'
        db.delete_table(db.shorten_name(u'videos_video_production_team'))
    ...
    models = {
        ...
        u'videos.video': {
            ...
            'farmers_shown': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['people.Person']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'production_team': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['people.Animator']", 'null': 'True', 'blank': 'True'}),
