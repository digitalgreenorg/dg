								...
								"<div>" +
									"<fieldset class='module aligned '>" +
										...
										"<div class='form-row videoes_screened  '>" +
											"<div>" +
												"<label for='id_videoes_screened' class='required'>Videoes screened:</label><select multiple='multiple' name='videoes_screened' id='id_videoes_screened' width='100' height='100'>" +
