...
public class AnimatorAssignedVillagesData extends BaseData{
	...
	protected static String[] createIndexes = {"CREATE INDEX IF NOT EXISTS animator_assigned_village_PRIMARY ON animator_assigned_village(id); ",
	...
	protected static String listAnimatorsAssignedVillages = "SELECT aav.id, a.id, a.name, vil.id,vil.VILLAGE_NAME,aav.start_date" +
			" FROM animator_assigned_village aav,animator a,village vil WHERE aav.animator_id = a.id" +
			" and aav.village_id = vil.id ORDER BY LOWER(a.name)";
