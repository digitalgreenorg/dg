...
public class AnimatorSalaryPerMonthData extends BaseData{
	...
	protected static String[] createIndexes = {"CREATE INDEX IF NOT EXISTS animator_salary_per_month_PRIMARY ON animator_salary_per_month(id);",
	...
	protected static String listAnimatorSalaryPerMonths = "SELECT * FROM animator_salary_per_month aav" +
			" JOIN animator a ON aav.animator_id = a.id " +
			"ORDER BY (-aav.id);";
	...
	public String getSaveOnlineURL(){
		return AnimatorSalaryPerMonthData.saveAnimatorSalaryPerMonthOnlineURL;
	}
