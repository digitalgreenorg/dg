...
public class PersonsData extends BaseData {
	...
	public class Data extends BaseData.Data {
		...
		public boolean validate() {
			StringValidator personName = new StringValidator(this.person_name,
					false, false, 0, 100);
			StringValidator fatherName = new StringValidator(this.father_name,
					true, true, 0, 100);
			IntegerValidator age = new IntegerValidator(this.age, true, true,
					0, 100);
			StringValidator phoneNo = new StringValidator(this.phone_no, true,
					true, 0, 100);
			StringValidator address = new StringValidator(this.address, true,
					true, 0, 500);
			IntegerValidator landHoldings = new IntegerValidator(
					this.land_holdings, true, true, 0, 200);
			return personName.validate() && fatherName.validate()
					&& age.validate() && phoneNo.validate()
