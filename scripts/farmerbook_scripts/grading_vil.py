...
if __name__ == "__main__":
    ...
    for i in range(len(village_id)):
        ...
        wrtr.writerow([grade1[i]['id'], grade1[i]['vil_name'], grade1[i]['grade_ratio'], 
                    grade2[i]['grade_ratio'],  grade3[i]['grade_ratio'], grade4[i]['grade_ratio'],
                    grade5[i]['question_grade_ratio'], grade5[i]['interests_grade_ratio'], final_grade])
        grd_file.flush()
    grd_file.close()
    print 'Done'