...
from social_website.migration_functions import update_questions_asked

class Migration(DataMigration):

    def forwards(self, orm):
        count = 0
        for pma in orm['dashboard.PersonMeetingAttendance'].objects.exclude(expressed_question='').prefetch_related('screening__videoes_screened'):
