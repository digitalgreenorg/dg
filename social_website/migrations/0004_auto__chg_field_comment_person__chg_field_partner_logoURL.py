...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Comment.person'
        raise RuntimeError("Cannot reverse this migration. 'Comment.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partner.logoURL'
        raise RuntimeError("Cannot reverse this migration. 'Partner.logoURL' and its values cannot be restored.")
