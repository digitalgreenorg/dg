...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_website_milestone', (
            ...
            ('videoNumber', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('villageNumber', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('screeningNumber', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('viewerNumber', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
