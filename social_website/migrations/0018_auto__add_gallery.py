...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'social_website_gallery', (
            ...
            ('flickrCode', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'social_website', ['Gallery'])


    def backwards(self, orm):
        # Deleting model 'Gallery'
        db.delete_table(u'social_website_gallery')
    ...
    models = {
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 2, 0, 0)'}),
