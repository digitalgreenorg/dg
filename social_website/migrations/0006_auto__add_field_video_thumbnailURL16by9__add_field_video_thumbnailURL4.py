...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.thumbnailURL16by9'
        db.add_column('social_website_video', 'thumbnailURL16by9',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Video.thumbnailURL4by3'
        db.add_column('social_website_video', 'thumbnailURL4by3',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.thumbnailURL16by9'
        db.delete_column('social_website_video', 'thumbnailURL16by9')

        # Deleting field 'Video.thumbnailURL4by3'
        db.delete_column('social_website_video', 'thumbnailURL4by3')
