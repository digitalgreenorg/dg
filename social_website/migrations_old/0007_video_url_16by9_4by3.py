...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for video in orm['social_website.Video'].objects.all():
            if(video.youtubeID != ""):
                video.thumbnailURL16by9 = "http://s3.amazonaws.com/video_thumbnail/16by9/" + video.uid + ".jpg"
                video.thumbnailURL4by3 = "http://s3.amazonaws.com/video_thumbnail/4by3/" + video.uid + ".jpg"
                video.save()
