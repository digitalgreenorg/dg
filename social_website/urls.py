...
urlpatterns = patterns('',
    ...
    url(r'^about/reports/1/field$', direct_to_template,{'template': 'field-developments-09.html'}),
    url(r'^about/reports/1/learning$', direct_to_template,{'template': 'learnings-09.html'}),
