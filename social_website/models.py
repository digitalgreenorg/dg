...
class Milestone(models.Model):
    uid = models.AutoField(primary_key=True)
    partner = models.ForeignKey(Partner)
    videoNumber = models.CharField(max_length=20)
    villageNumber = models.CharField(max_length=20)
    screeningNumber = models.CharField(max_length=20)
    viewerNumber = models.CharField(max_length=20)