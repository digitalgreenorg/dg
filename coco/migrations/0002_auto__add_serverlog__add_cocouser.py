...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'coco_cocouser', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'coco_cocouser_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'coco_cocouser_related_modified', null=True, to=orm['auth.User'])),
        ...
        # Adding M2M table for field villages on 'CocoUser'
        db.create_table(u'coco_cocouser_villages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cocouser', models.ForeignKey(orm[u'coco.cocouser'], null=False)),
            ('village', models.ForeignKey(orm[u'geographies.village'], null=False))
        ))
        db.create_unique(u'coco_cocouser_villages', ['cocouser_id', 'village_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'coco_cocouser')

        # Removing M2M table for field villages on 'CocoUser'
        db.delete_table('coco_cocouser_villages')
