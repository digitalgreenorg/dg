...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CocoUser.old_coco_id'
        db.alter_column(u'coco_cocouser', 'old_coco_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CocoUser.old_coco_id'
        db.alter_column(u'coco_cocouser', 'old_coco_id', self.gf('django.db.models.fields.IntegerField')(default=0))
