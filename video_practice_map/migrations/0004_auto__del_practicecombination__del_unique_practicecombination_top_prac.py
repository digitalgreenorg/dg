...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PracticeCombination'
        db.delete_foreign_key('video_practice_map_videopractice', 'practice_id')
        db.delete_table('video_practice_map_practicecombination')
        # Changing field 'VideoPractice.practice'
        db.alter_column('video_practice_map_videopractice', 'practice_id', self.gf('dashboard.fields.BigForeignKey')(to=orm['dashboard.Practices']))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'PracticeCombination', fields ['top_practice', 'sub_practice', 'utility', 'type', 'subject']
        db.create_unique('video_practice_map_practicecombination', ['top_practice_id', 'sub_practice_id', 'utility_id', 'type_id', 'subject_id'])
        # Changing field 'VideoPractice.practice'
        db.alter_column('video_practice_map_videopractice', 'practice_id', self.gf('dashboard.fields.BigForeignKey')(to=orm['video_practice_map.PracticeCombination']))
