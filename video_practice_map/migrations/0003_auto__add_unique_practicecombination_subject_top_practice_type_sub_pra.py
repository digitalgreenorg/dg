...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PracticeCombination', fields ['subject', 'top_practice', 'type', 'sub_practice', 'utility']
        db.create_unique('video_practice_map_practicecombination', ['subject_id', 'top_practice_id', 'type_id', 'sub_practice_id', 'utility_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PracticeCombination', fields ['subject', 'top_practice', 'type', 'sub_practice', 'utility']
        db.delete_unique('video_practice_map_practicecombination', ['subject_id', 'top_practice_id', 'type_id', 'sub_practice_id', 'utility_id'])
    ...
    models = {
        ...
        'video_practice_map.practicecombination': {
            'Meta': {'unique_together': "(('top_practice', 'sub_practice', 'utility', 'type', 'subject'),)", 'object_name': 'PracticeCombination'},
            'id': ('dashboard.fields.BigAutoField', [], {'primary_key': 'True'}),
