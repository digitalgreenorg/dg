...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoPractice.user'
        db.add_column('video_practice_map_videopractice', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Adding field 'VideoPractice.review_user'
        db.add_column('video_practice_map_videopractice', 'review_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewed_practices', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'VideoPractice.review_approved'
        db.add_column('video_practice_map_videopractice', 'review_approved', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoPractice.user'
        db.delete_column('video_practice_map_videopractice', 'user_id')

        # Deleting field 'VideoPractice.review_user'
        db.delete_column('video_practice_map_videopractice', 'review_user_id')

        # Deleting field 'VideoPractice.review_approved'
        db.delete_column('video_practice_map_videopractice', 'review_approved')
