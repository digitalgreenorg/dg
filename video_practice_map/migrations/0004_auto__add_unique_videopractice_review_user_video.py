...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VideoPractice', fields ['review_user', 'video']
        db.create_unique('video_practice_map_videopractice', ['review_user_id', 'video_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VideoPractice', fields ['review_user', 'video']
        db.delete_unique('video_practice_map_videopractice', ['review_user_id', 'video_id'])
