...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoQualityReview.qareviewer'
        db.delete_column(u'qacoco_videoqualityreview', 'qareviewer_id')

        # Adding field 'VideoQualityReview.qareviewername'
        db.add_column(u'qacoco_videoqualityreview', 'qareviewername',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'AdoptionVerification.qareviewer'
        db.delete_column(u'qacoco_adoptionverification', 'qareviewer_id')

        # Adding field 'AdoptionVerification.qareviewername'
        db.add_column(u'qacoco_adoptionverification', 'qareviewername',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=34, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'DisseminationQuality.qareviewer'
        db.delete_column(u'qacoco_disseminationquality', 'qareviewer_id')

        # Adding field 'DisseminationQuality.qareviewername'
        db.add_column(u'qacoco_disseminationquality', 'qareviewername',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=24, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoQualityReview.qareviewer'
        db.add_column(u'qacoco_videoqualityreview', 'qareviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=20, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'VideoQualityReview.qareviewername'
        db.delete_column(u'qacoco_videoqualityreview', 'qareviewername_id')

        # Adding field 'AdoptionVerification.qareviewer'
        db.add_column(u'qacoco_adoptionverification', 'qareviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=23, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'AdoptionVerification.qareviewername'
        db.delete_column(u'qacoco_adoptionverification', 'qareviewername_id')

        # Adding field 'DisseminationQuality.qareviewer'
        db.add_column(u'qacoco_disseminationquality', 'qareviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'DisseminationQuality.qareviewername'
        db.delete_column(u'qacoco_disseminationquality', 'qareviewername_id')
    ...
    models = {
        ...
        u'qacoco.adoptionverification': {
            ...
            'qareviewername': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qacoco.QAReviewerName']"}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'qacoco.qareviewername': {
            'Meta': {'object_name': 'QAReviewerName'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'reviewer_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qacoco.QAReviewer']"})
        },
        u'qacoco.serverlog': {
