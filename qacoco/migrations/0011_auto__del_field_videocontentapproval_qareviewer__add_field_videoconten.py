...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoContentApproval.qareviewername'
        db.add_column(u'qacoco_videocontentapproval', 'qareviewername',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'qacoco_videocontentapproval', 'qareviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['qacoco.QAReviewerName']),
                      keep_default=False)

        # Deleting field 'VideoContentApproval.qareviewername'
        db.delete_column(u'qacoco_videocontentapproval', 'qareviewername_id')
