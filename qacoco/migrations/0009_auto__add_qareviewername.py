...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QAReviewerName'
        db.create_table(u'qacoco_qareviewername', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reviewer_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'qacoco', ['QAReviewerName'])
    ...
    def backwards(self, orm):
        # Deleting model 'QAReviewerName'
        db.delete_table(u'qacoco_qareviewername')
