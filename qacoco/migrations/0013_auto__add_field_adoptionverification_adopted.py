...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdoptionVerification.adopted'
        db.add_column(u'qacoco_adoptionverification', 'adopted',
                      self.gf('django.db.models.fields.IntegerField')(default=21),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdoptionVerification.adopted'
        db.delete_column(u'qacoco_adoptionverification', 'adopted')
    ...
    models = {
        ...
        u'qacoco.adoptionverification': {
            ...
            'adopted': ('django.db.models.fields.IntegerField', [], {}),
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geographies.Block']"}),
