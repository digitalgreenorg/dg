...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qacoco_disseminationquality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_disseminationquality_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_disseminationquality_related_modified', null=True, to=orm['auth.User'])),
            ...
            ('equipments_setup_handling', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('context_setting', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('facilitation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('subject_knowledge', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('documentation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('total_score', self.gf('django.db.models.fields.IntegerField')()),
            ('video_grade', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
        ...
        db.send_create_signal(u'qacoco', ['DisseminationQuality'])


    def backwards(self, orm):
        # Deleting model 'DisseminationQuality'
        db.delete_table(u'qacoco_disseminationquality')
