...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qacoco_videocontentapproval', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_videocontentapproval_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_videocontentapproval_related_modified', null=True, to=orm['auth.User'])),
            ...
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer'])),
            ('suitable_for', self.gf('django.db.models.fields.IntegerField')(max_length=1)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['videos.Category'])),
            ('sub_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubCategory'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'qacoco', ['VideoContentApproval'])

        # Adding model 'QAReviewer'
        db.create_table(u'qacoco_qareviewer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reviewer_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'qacoco', ['QAReviewer'])


    def backwards(self, orm):
        # Deleting model 'VideoContentApproval'
        db.delete_table(u'qacoco_videocontentapproval')

        # Deleting model 'QAReviewer'
        db.delete_table(u'qacoco_qareviewer')
    ...
    models = {
        ...
        u'qacoco.videocontentapproval': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['videos.Category']"}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qacoco.QAReviewer']"}),
            'sub_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['videos.SubCategory']"}),
