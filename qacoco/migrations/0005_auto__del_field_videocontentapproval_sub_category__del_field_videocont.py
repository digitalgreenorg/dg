...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoContentApproval.sub_category'
        db.delete_column(u'qacoco_videocontentapproval', 'sub_category_id')

        # Deleting field 'VideoContentApproval.category'
        db.delete_column(u'qacoco_videocontentapproval', 'category_id')


    def backwards(self, orm):
        # Adding field 'VideoContentApproval.sub_category'
        db.add_column(u'qacoco_videocontentapproval', 'sub_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['videos.SubCategory']),
                      keep_default=False)

        # Adding field 'VideoContentApproval.category'
        db.add_column(u'qacoco_videocontentapproval', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['videos.Category']),
                      keep_default=False)
