...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdoptionVerification.adopted'
        db.alter_column(u'qacoco_adoptionverification', 'adopted', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AdoptionVerification.adopted'
        db.alter_column(u'qacoco_adoptionverification', 'adopted', self.gf('django.db.models.fields.IntegerField')(default=21))
    ...
    models = {
        ...
        u'qacoco.adoptionverification': {
            ...
            'adopted': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geographies.Block']"}),
