...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qacoco_videoqualityreview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_videoqualityreview_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'qacoco_videoqualityreview_related_modified', null=True, to=orm['auth.User'])),
            ...
            ('storystructure', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('framing', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('camera_angles', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('camera_movement', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('light', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('audio_sound', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('continuity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('interview', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('technical', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('style_guide', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('total_score', self.gf('django.db.models.fields.IntegerField')()),
            ('video_grade', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.send_create_signal(u'qacoco', ['VideoQualityReview'])


    def backwards(self, orm):
        # Deleting model 'VideoQualityReview'
        db.delete_table(u'qacoco_videoqualityreview')
