...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoQualityReview.qareviewer'
        db.alter_column(u'qacoco_videoqualityreview', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewerName']))

        # Changing field 'AdoptionVerification.qareviewer'
        db.alter_column(u'qacoco_adoptionverification', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewerName']))

        # Changing field 'DisseminationQuality.qareviewer'
        db.alter_column(u'qacoco_disseminationquality', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewerName']))

        # Changing field 'VideoContentApproval.qareviewer'
        db.alter_column(u'qacoco_videocontentapproval', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewerName']))

    def backwards(self, orm):

        # Changing field 'VideoQualityReview.qareviewer'
        db.alter_column(u'qacoco_videoqualityreview', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer']))

        # Changing field 'AdoptionVerification.qareviewer'
        db.alter_column(u'qacoco_adoptionverification', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer']))

        # Changing field 'DisseminationQuality.qareviewer'
        db.alter_column(u'qacoco_disseminationquality', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer']))

        # Changing field 'VideoContentApproval.qareviewer'
        db.alter_column(u'qacoco_videocontentapproval', 'qareviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qacoco.QAReviewer']))
    ...
    models = {
        ...
        u'qacoco.adoptionverification': {
            ...
            'qareviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qacoco.QAReviewerName']"}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
