...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qacoco_fulldownloadstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qacoco_user', to=orm['auth.User'])),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'qacoco', ['FullDownloadStats'])

        # Adding model 'ServerLog'
        db.create_table(u'qacoco_serverlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qacocoserverlog_user', null=True, to=orm['auth.User'])),
            ...
            ('partner', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'qacoco', ['ServerLog'])

        # Deleting field 'VideoContentApproval.reviewer'
        db.delete_column(u'qacoco_videocontentapproval', 'reviewer_id')

        # Adding field 'VideoContentApproval.qareviewer'
        db.add_column(u'qacoco_videocontentapproval', 'qareviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qacoco.QAReviewer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FullDownloadStats'
        db.delete_table(u'qacoco_fulldownloadstats')

        # Deleting model 'ServerLog'
        db.delete_table(u'qacoco_serverlog')

        # Adding field 'VideoContentApproval.reviewer'
        db.add_column(u'qacoco_videocontentapproval', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['qacoco.QAReviewer']),
                      keep_default=False)

        # Deleting field 'VideoContentApproval.qareviewer'
        db.delete_column(u'qacoco_videocontentapproval', 'qareviewer_id')
