...
class DisseminationQuality(QACocoModel):
    ...
    introduce_topic = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    paused_video = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    encouraged_adoption = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    summarized_video = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    subject_knowledge = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    filled_dissemination = models.IntegerField(choices=SCORE_CHOICES,null=True,blank=True)
    total_score = models.IntegerField()
