...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PracticeMain'
        db.create_table(u'practice_main', (
            ('id', self.gf('dashboard.fields.BigAutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('dashboard', ['PracticeMain'])
        ...
        # Adding model 'PracticeSub'
        db.create_table(u'practice_sub', (
            ('id', self.gf('dashboard.fields.BigAutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('dashboard', ['PracticeSub'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PracticeMain'
        db.delete_table(u'practice_main')
        ...
        # Deleting model 'PracticeSub'
        db.delete_table(u'practice_sub')
