...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'SCREENING_farmer_groups_targeted', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groupstargetedinscreening_related_created', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'GroupsTargetedInScreening.user_modified'
        db.add_column(u'SCREENING_farmer_groups_targeted', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groupstargetedinscreening_related_modified', null=True, to=orm['auth.User'], blank=True), keep_default=False)
        ...
        db.add_column(u'SCREENING_videoes_screened', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videosscreenedinscreening_related_created', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'VideosScreenedInScreening.user_modified'
        db.add_column(u'SCREENING_videoes_screened', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videosscreenedinscreening_related_modified', null=True, to=orm['auth.User'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 25, 7, 966000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 25, 7, 966000)'}),
