...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'VILLAGE', 'latitude',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Village.longitude'
        db.add_column(u'VILLAGE', 'longitude',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Village.grade'
        db.add_column(u'VILLAGE', 'grade',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Village.latitude'
        db.delete_column(u'VILLAGE', 'latitude')

        # Deleting field 'Village.longitude'
        db.delete_column(u'VILLAGE', 'longitude')

        # Deleting field 'Village.grade'
        db.delete_column(u'VILLAGE', 'grade')
