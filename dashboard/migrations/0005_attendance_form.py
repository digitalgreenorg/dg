...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'PERSON_MEETING_ATTENDANCE', 'expressed_adoption_video', self.gf('dashboard.fields.BigForeignKey')(blank=True, related_name='expressed_adoption_video', null=True, db_column='EXPRESSED_ADOPTION_VIDEO', to=orm['dashboard.Video']), keep_default=False)
