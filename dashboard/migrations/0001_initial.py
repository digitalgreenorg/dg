...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'PERSON_MEETING_ATTENDANCE', (
            ...
            ('expressed_interest_practice', self.gf('dashboard.fields.BigForeignKey')(blank=True, related_name='expressed_interest_practice', null=True, to=orm['dashboard.Practices'])),
            ('expressed_interest', self.gf('django.db.models.fields.CharField')(max_length=500, db_column='EXPRESSED_INTEREST', blank=True)),
            ('expressed_adoption_practice', self.gf('dashboard.fields.BigForeignKey')(blank=True, related_name='expressed_adoption_practice', null=True, to=orm['dashboard.Practices'])),
            ('expressed_adoption', self.gf('django.db.models.fields.CharField')(max_length=500, db_column='EXPRESSED_ADOPTION', blank=True)),
            ('expressed_question_practice', self.gf('dashboard.fields.BigForeignKey')(blank=True, related_name='expressed_question_practice', null=True, to=orm['dashboard.Practices'])),
        ...
        # Adding unique constraint on 'PersonAdoptPractice', fields ['person', 'practice', 'date_of_adoption']
        db.create_unique(u'PERSON_ADOPT_PRACTICE', ['person_id', 'practice_id', 'DATE_OF_ADOPTION'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'PersonAdoptPractice', fields ['person', 'practice', 'date_of_adoption']
        db.delete_unique(u'PERSON_ADOPT_PRACTICE', ['person_id', 'practice_id', 'DATE_OF_ADOPTION'])
