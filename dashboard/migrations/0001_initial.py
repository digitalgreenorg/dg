...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_offlineuser', (
            ...
            ('offline_pk_id', self.gf('dashboard.fields.fields.PositiveBigIntegerField')()),
        ))
        ...
        db.create_table(u'development_manager', (
            ...
            ('region', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Region'])),
        ...
        db.create_table(u'state', (
            ...
            ('region', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Region'])),
            ('country', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Country'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, db_column='START_DATE', blank=True)),
        ))
        ...
        db.create_table(u'district', (
            ...
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, db_column='START_DATE', blank=True)),
            ('state', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.State'])),
            ('fieldofficer', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.FieldOfficer'])),
            ('fieldofficer_startday', self.gf('django.db.models.fields.DateField')(null=True, db_column='FIELDOFFICER_STARTDAY', blank=True)),
            ('partner', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Partners'])),
        ))
        ...
        db.create_table(u'village', (
            ...
            ('block', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Block'])),
        ...
        db.create_table(u'person', (
            ...
            ('village', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'])),
            ('group', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.PersonGroups'], null=True, blank=True)),
        ...
        db.create_table(u'animator', (
            ...
            ('address', self.gf('django.db.models.fields.CharField')(max_length=500, db_column='ADDRESS', blank=True)),
            ('partner', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Partners'])),
            ('village', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'], db_column='home_village_id')),
        ...
        db.create_table(u'video', (
            ...
            ('language', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Language'])),
            ...
            ('village', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'])),
            ('facilitator', self.gf('dashboard.fields.related.BigForeignKey')(related_name='facilitator', to=orm['dashboard.Animator'])),
            ('cameraoperator', self.gf('dashboard.fields.related.BigForeignKey')(related_name='cameraoperator', to=orm['dashboard.Animator'])),
            ('reviewer', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Reviewer'], null=True, blank=True)),
            ('approval_date', self.gf('django.db.models.fields.DateField')(null=True, db_column='APPROVAL_DATE', blank=True)),
            ('supplementary_video_produced', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Video'], null=True, blank=True)),
            ...
            ('related_practice', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Practices'], null=True, blank=True)),
        ...
        db.create_table(u'practices', (
            ...
            ('summary', self.gf('django.db.models.fields.TextField')(db_column='SUMMARY', blank=True)),
            ('practice_sector', self.gf('dashboard.fields.related.BigForeignKey')(default=1, to=orm['dashboard.PracticeSector'])),
            ('practice_subsector', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.PracticeSubSector'], null=True)),
            ('practice_topic', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.PracticeTopic'], null=True)),
            ('practice_subtopic', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.PracticeSubtopic'], null=True)),
            ('practice_subject', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.PracticeSubject'], null=True)),
        ))
        ...
        db.create_table(u'screening', (
            ...
            ('village', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'])),
            ('fieldofficer', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.FieldOfficer'], null=True, blank=True)),
            ('animator', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Animator'])),
        ))
        ...
        db.create_table(u'person_adopt_practice', (
            ('id', self.gf('dashboard.fields.fields.BigAutoField')(primary_key=True)),
            ('person', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Person'])),
            ('video', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Video'])),
        ...
        db.create_table(u'person_meeting_attendance', (
            ('id', self.gf('dashboard.fields.fields.BigAutoField')(primary_key=True)),
            ('screening', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Screening'])),
            ('person', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Person'])),
            ...
            ('expressed_adoption_video', self.gf('dashboard.fields.related.BigForeignKey')(blank=True, related_name='expressed_adoption_video', null=True, db_column='EXPRESSED_ADOPTION_VIDEO', to=orm['dashboard.Video'])),
        ))
        ...
        db.create_table('dashboard_userpermission', (
            ...
            ('region_operated', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Region'], null=True, blank=True)),
            ('district_operated', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.District'], null=True, blank=True)),
        ))
        ...
        db.create_table('dashboard_error', (
            ...
            ('object_id1', self.gf('dashboard.fields.fields.PositiveBigIntegerField')()),
            ...
            ('object_id2', self.gf('dashboard.fields.fields.PositiveBigIntegerField')(null=True)),
