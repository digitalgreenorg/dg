...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'animator', 'home_village_id')


    def backwards(self, orm):
        # Adding field 'Animator.village'
        db.add_column(u'animator', 'village',
                      self.gf('dashboard.fields.related.BigForeignKey')(default=None, to=orm['dashboard.Village'], db_column='home_village_id'),
                      keep_default=False)
