...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Fill in the new expressed_interest_video column from the old expressed_interest_practice."
    ...
    def backwards(self, orm):
        "Backfill expressed_interest_practice from expressed_interest_video."
