...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Animator.total_adoptions'
        db.add_column(u'ANIMATOR', 'total_adoptions', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Animator.total_adoptions'
        db.delete_column(u'ANIMATOR', 'total_adoptions')
