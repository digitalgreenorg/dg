...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        pradan = orm['dashboard.Partners'].objects.get(id=10000000000001) 
        pradan.description = "An India-based NGO that works across 7 of India's poorest states and that promotes self-help groups (SHGs), develops locally suitable economic activities, mobilizes finances, and introduces systems to improve livelihoods of the rural poor. Digital Green is currently working with PRADAN in Madhya Pradesh, Jharkhand, and Orissa states."
        pradan.logoURL='http://www.digitalgreen.org/media/Output/Images/partner/pradan_logo1.PNG'
        pradan.save()
        
        baif = orm['dashboard.Partners'].objects.get(id=10000000000002) 
        baif.description="An India-based NGO working in more than 47,000 villages in 12 states in India focused on the areas of livestock, watershed, and land resources development. Digital Green is currently working with BAIF in Karnataka state."
        baif.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/baif_logo1.PNG"
        baif.save()
        
        sps = orm['dashboard.Partners'].objects.get(id=10000000000004) 
        sps.description = "An India-based NGO that works through its partners in 72 of India's most backward districts to ensure water and livelihood security for the tribal communities living there. Digital Green is currently working with SPS in the Dewas District of Madhya Pradesh state."
        sps.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/samaj_logo1.PNG"
        sps.save()
        
        access = orm['dashboard.Partners'].objects.get(id=10000000000007) 
        access.description = "An India-based NGO working in the areas of livelihood and microfinance development in six Indian states. Digital Green is currently working with ACCESS in Madhya Pradesh state."
        access.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/access_logo1.PNG"
        access.save()
        
        asa = orm['dashboard.Partners'].objects.get(id=10000000000008) 
        asa.description = "An India-based NGO working with 120,000 families across 1,000 villages in 15 districts of Madhya Pradesh and Bihar in the area of ensuring of improving livelihoods on a sustainable basis with linkages to the Government of India's Agriculture Technology Management Agency (ATMA) initiative. Digital Green is currently working ASA in Madhya Pradesh state."
        asa.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/asa_logo1.PNG"
        asa.save()
        
        pragati = orm['dashboard.Partners'].objects.get(id=10000000000009) 
        pragati.description = "Pragati, Koraput is a India-based NGO working in the areas of soil and water conservation, promotion of sustainable agriculture through organic practices, and introduction of new crop production technologies for food and income security of small and marginal farmers. Digital Green is currently working with Pragati, Koraput in Orissa state."
        pragati.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/pragati_logo1.png"
        pragati.save()
        
        varrat = orm['dashboard.Partners'].objects.get(id=10000000000010) 
        varrat.description = "VARRAT is a India-based NGO working in the area of livelihood and rural development to empower village communities to enable their self-sufficiency and self-sustainability. Digital Green is currently working with VARRAT in northern Orissa state."
        varrat.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/varrat_logo1.png"
        varrat.save()
        
        serp = orm['dashboard.Partners'].objects.get(id=10000000000011) 
        serp.description = "Society for Elimination of Rural Poverty (SERP) is an autonomous society of the Department of Rural Development, Government of Andhra Pradesh. Digital Green is currently working with SERP in the Andhra Pradesh Pradesh state."
        serp.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/serp_logo1.png"
        serp.save()
        
        brlps = orm['dashboard.Partners'].objects.get(id=10000000000013) 
        brlps.description = "Bihar Rural Livelihoods Promotion Society (BRLPS) is an independent society set up by the Government of Bihar and supported by the World Bank. The BRLPS is implementing JEEVIKA - Bihar Rural Livelihoods Project with the objective of enhancing the social and economic empowerment of the rural poor in Bihar. Digital Green is currently working with BRLPS in Bihar state."
        brlps.logoURL="http://www.digitalgreen.org/media/Output/Images/partner/brlps.png"
        brlps.save()
