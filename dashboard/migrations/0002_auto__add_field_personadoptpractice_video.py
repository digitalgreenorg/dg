...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonAdoptPractice.video'
        db.add_column(u'PERSON_ADOPT_PRACTICE', 'video', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dashboard.Video']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonAdoptPractice.video'
        db.delete_column(u'PERSON_ADOPT_PRACTICE', 'video_id')
