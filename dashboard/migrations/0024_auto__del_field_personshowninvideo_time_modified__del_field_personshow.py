...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'VIDEO_farmers_shown', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personshowninvideo_related_created', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'PersonShownInVideo.user_modified'
        db.add_column(u'VIDEO_farmers_shown', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personshowninvideo_related_modified', null=True, to=orm['auth.User'], blank=True), keep_default=False)
        ...
        db.add_column(u'TRAINING_animators_trained', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name='traininganimatorstrained_related_created', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'TrainingAnimatorsTrained.user_modified'
        db.add_column(u'TRAINING_animators_trained', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name='traininganimatorstrained_related_modified', null=True, to=orm['auth.User'], blank=True), keep_default=False)
        ...
        db.add_column(u'PERSON_RELATIONS', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personrelations_related_created', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'PersonRelations.user_modified'
        db.add_column(u'PERSON_RELATIONS', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name='personrelations_related_modified', null=True, to=orm['auth.User'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 38, 34, 657000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 38, 34, 657000)'}),
