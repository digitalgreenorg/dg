...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dashboard_offlineuser', 'user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='offlineuser_related_created', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'OfflineUser.time_created'
        db.add_column('dashboard_offlineuser', 'time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_column='TIME_CREATED', blank=True), keep_default=False)

        # Adding field 'OfflineUser.user_modified'
        db.add_column('dashboard_offlineuser', 'user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='offlineuser_related_modified', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'OfflineUser.time_modified'
        db.add_column('dashboard_offlineuser', 'time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_column='TIME_MODIFIED', blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 12, 42, 3, 972000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 12, 42, 3, 972000)'}),
