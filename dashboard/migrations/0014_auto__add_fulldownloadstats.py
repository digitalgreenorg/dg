...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_fulldownloadstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fulldownloadstats_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fulldownloadstats_related_modified', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('dashboard', ['FullDownloadStats'])


    def backwards(self, orm):
        # Deleting model 'FullDownloadStats'
        db.delete_table('dashboard_fulldownloadstats')
    ...
    models = {
        ...
        'dashboard.fulldownloadstats': {
            ...
            'user_created': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fulldownloadstats_created'", 'null': 'True', 'to': "orm['auth.User']"}),
            'user_modified': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fulldownloadstats_related_modified'", 'null': 'True', 'to': "orm['auth.User']"})
        },
