...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PersonMeetingAttendance', fields ['interested']
        db.create_index(u'PERSON_MEETING_ATTENDANCE', ['INTERESTED'])


    def backwards(self, orm):
        
        # Removing index on 'PersonMeetingAttendance', fields ['interested']
        db.delete_index(u'PERSON_MEETING_ATTENDANCE', ['INTERESTED'])
