...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'PERSON_ADOPT_PRACTICE', 'practice_id', self.gf('dashboard.fields.BigForeignKey')(to=orm['dashboard.Practices'], null=True))


    def backwards(self, orm):
        
        # Changing field 'PersonAdoptPractice.practice'
        db.alter_column(u'PERSON_ADOPT_PRACTICE', 'practice_id', self.gf('dashboard.fields.BigForeignKey')(default=None, to=orm['dashboard.Practices']))
