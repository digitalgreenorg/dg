...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonAdoptPractice.practice'
        db.alter_column(u'PERSON_ADOPT_PRACTICE', 'practice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Practices'], null=True))


    def backwards(self, orm):
        
        # Changing field 'PersonAdoptPractice.practice'
        db.alter_column(u'PERSON_ADOPT_PRACTICE', 'practice_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dashboard.Practices']))
