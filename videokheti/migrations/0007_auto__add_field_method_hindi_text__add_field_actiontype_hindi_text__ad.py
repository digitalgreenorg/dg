...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Method.hindi_text'
        db.add_column(u'videokheti_method', 'hindi_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionType.hindi_text'
        db.add_column(u'videokheti_actiontype', 'hindi_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimeYear.hindi_text'
        db.add_column(u'videokheti_timeyear', 'hindi_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.hindi_text'
        db.add_column(u'videokheti_video', 'hindi_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Crop.hindi_text'
        db.add_column(u'videokheti_crop', 'hindi_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Method.hindi_text'
        db.delete_column(u'videokheti_method', 'hindi_text')

        # Deleting field 'ActionType.hindi_text'
        db.delete_column(u'videokheti_actiontype', 'hindi_text')

        # Deleting field 'TimeYear.hindi_text'
        db.delete_column(u'videokheti_timeyear', 'hindi_text')

        # Deleting field 'Video.hindi_text'
        db.delete_column(u'videokheti_video', 'hindi_text')

        # Deleting field 'Crop.hindi_text'
        db.delete_column(u'videokheti_crop', 'hindi_text')
    ...
    models = {
        ...
        u'videokheti.actiontype': {
            ...
            'hindi_text': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'videokheti.videocomment': {
            'Meta': {'object_name': 'VideoComment'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imageURL': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'personName': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['videokheti.Video']"})
        },
        u'videos.language': {
