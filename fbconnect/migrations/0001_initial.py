...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('fbconnect', ['FBUser'])
        ...
        db.create_table('fb_followers', (
            ...
            ('person', self.gf('dashboard.fields.PositiveBigIntegerField')(null=True)),
        ))
        db.send_create_signal('fbconnect', ['FBFollowers'])
    ...
    models = {
        'fbconnect.fbfollowers': {
            ...
            'person': ('dashboard.fields.PositiveBigIntegerField', [], {'null': 'True'})
        },
        'fbconnect.fbuser': {
