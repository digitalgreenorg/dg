...
urlpatterns = patterns('',
    ...
    (r'^dashboard/getvideorelatedagriculturalpracticesonline/$', get_videoagriculturalpractices_online),
    ...
    (r'^dashboard/getvideofarmersonline/', get_personshowninvideo_online),
    ...
    (r'^dashboard/getscreeningfarmergroupstargetedsonline/',get_groupstargetedinscreening_online),
    ...
    (r'^dashboard/getscreeningvideosscreenedsonline/', get_videosscreenedinscreening_online),
