...
#    (r'^site_media/(?P<path>.*)$', 'django.views.static.serve',{'document_root': settings.STATIC_DOC_ROOT, 'show_indexes': True}),
    ...
    (r'^output/base_team/$', others.base_team),
    (r'^output/base_team_board/$', others.base_team_board),
    (r'^output/base_team_adviser/$', others.base_team_adviser),
    (r'^output/base_team_acclaw/$', others.base_team_acclaw),
    (r'^output/base_team_intern/$', others.base_team_intern),
    (r'^output/base_team_alumni/$', others.base_team_alumni),
    (r'^output/base_press/$', others.base_press),
    (r'^output/base_partner/$', others.base_partner),    
