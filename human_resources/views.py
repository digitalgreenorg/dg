...
def job_view(request):
    ...
    return render_to_response('career.html',{'job_list':job_list, 'header': {'jsController':'Team', 'loggedIn':False,'currentPage':'Careers'}}, context_instance=RequestContext(request))
