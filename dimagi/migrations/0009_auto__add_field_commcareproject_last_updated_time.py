...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommCareProject.last_updated_time'
        db.add_column('dimagi_commcareproject', 'last_updated_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommCareProject.last_updated_time'
        db.delete_column('dimagi_commcareproject', 'last_updated_time')
