...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dimagi_commcareuservillage', (
        ...
        db.send_create_signal('dimagi', ['CommCareUserVillage'])

        # Adding model 'CommCareCase'
        db.create_table('dimagi_commcarecase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('dimagi', ['CommCareCase'])

        # Adding unique constraint on 'CommCareCase', fields ['is_open', 'person', 'project', 'user']
        db.create_unique('dimagi_commcarecase', ['is_open', 'person_id', 'project_id', 'user_id'])

        # Adding model 'CommCareProject'
        db.create_table('dimagi_commcareproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
        ))
        db.send_create_signal('dimagi', ['CommCareProject'])

        # Adding model 'CommCareUser'
        db.create_table('dimagi_commcareuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dimagi.CommCareProject'])),
        ))
        db.send_create_signal('dimagi', ['CommCareUser'])

        # Adding unique constraint on 'CommCareUser', fields ['project', 'username']
        db.create_unique('dimagi_commcareuser', ['project_id', 'username'])


        # Changing field 'XMLSubmission.username'
        db.alter_column('dimagi_xmlsubmission', 'username', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):
        # Removing unique constraint on 'CommCareUser', fields ['project', 'username']
        db.delete_unique('dimagi_commcareuser', ['project_id', 'username'])

        # Removing unique constraint on 'CommCareCase', fields ['is_open', 'person', 'project', 'user']
        db.delete_unique('dimagi_commcarecase', ['is_open', 'person_id', 'project_id', 'user_id'])

        # Deleting model 'CommCareUserVillage'
        db.delete_table('dimagi_commcareuservillage')

        # Deleting model 'CommCareCase'
        db.delete_table('dimagi_commcarecase')

        # Deleting model 'CommCareProject'
        db.delete_table('dimagi_commcareproject')

        # Deleting model 'CommCareUser'
        db.delete_table('dimagi_commcareuser')


        # Changing field 'XMLSubmission.username'
        db.alter_column('dimagi_xmlsubmission', 'username', self.gf('django.db.models.fields.TextField')())
