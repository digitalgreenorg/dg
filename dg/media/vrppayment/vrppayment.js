...
function districtfilter(partner_id)
    {
       j$.ajax(
       {
        ...
        url: window.location.origin + "/coco/vrp/getdistrict",
    ...
    j$.ajax(
        {
            ...
            url: window.location.origin + "/coco/vrp/getblock",
    ...
    if ((sdate == "" || edate == "" || partner_name == "" || district_name == "" ||  block_name == "" || block_name == "-------")) {
      ...
      if((sdateArr[1] > edateArr[1]) || (sdateArr[1] == edateArr[1] && sdateArr[0] > edateArr[0])) {
        ...
        j$.ajax({
            ...
            url: window.location.origin + "/coco/vrp/report",
...
//                    ],
                ...
                "buttons": [
                    ...
                    "title": 'VRP Payment ' + block_name + ' ' + sdate + ' - '+ edate,
                    },
                    {
                    "extend": 'csvHtml5',
