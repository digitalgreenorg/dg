...
function partnersetter()
    {
        ...
        {
         type:'GET',
         url: window.location.origin + "/analytics/coco/api/getpartner",
...
function districtfilter(partner_id)
    {
       $.ajax(
       {
        ...
        url: window.location.origin + "/analytics/coco/api/getdistrict",
...
function setdistrictlistdiv(text, partner_id)
    {
        ...
        if(address == 'http://127.0.0.1:8000/analytics/coco/users/'){
        	deofilter(district_id, partner_id);
    ...
    $.ajax(
        {
            ...
            url: window.location.origin + "/analytics/coco/payment/api/getblock",
...
function vrp_payment_goclicked() {
    ...
    $.ajax({
        ...
        url: window.location.origin + "/analytics/coco/payment/api/report",
        success: function (data) {
            var listitems = data;
...
/* DEO analytics code starts here */
function deofilter(district_id, partner_id)
    {
       $.ajax(
       {
          type:'GET',
          ...
          url: window.location.origin + "/analytics/coco/users/api/getdeo",
    ...
    $.ajax(
            {
               ...
               url:window.location.origin + "/analytics/coco/users/api/getthedeo",
