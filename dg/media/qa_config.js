...
function() {
    ...
    var VideoQualityReview_configs = {
        ...
        'list_elements_English': [{'header':'Video Id','element':'video.id'}, {'header':'Video Title','element':'video.title'},{'header':'Reviewer','element':'qareviewername.name'},{'header':'Q1','element':'storystructure'},{'header':'Q2','element':'framing'},{'header':'Q3','element':'continuity'},{'header':'Q4','element':'camera_angles'},{'header':'Q5','element':'camera_movement'},{'header':'Q6','element':'light'},{'header':'Q7','element':'audio_sound'},{'header':'Q8','element':'interview'},{'header':'Q9','element':'technical'},{'header':'Q10','element':'style_guide'},{'header':'Total Score','element':'total_score'}],
    ...
    var DisseminationQuality_configs = {
        ...
        'labels_English': {add_row:"Add Empty Rows"},
        'list_elements_English': [{'header':'Block','element':'block.block_name'}, {'header':'Village','element':'village.village_name'},{'header':'Mediator','element':'mediator.name'},{'header':'Reviewer','element':'qareviewername.name'},{'header':'Q1','element':'equipments_setup_handling'},{'header':'Q2','element':'context_setting'},{'header':'Q3','element':'introduce_topic'},{'header':'Q4','element':'paused_video'},{'header':'Q5','element':'encouraged_adoption'},{'header':'Q6','element':'summarized_video'},{'header':'Q7','element':'subject_knowledge'},{'header':'Q8','element':'filled_dissemination'}, {'header':'Total Score','element':'total_score'}],
