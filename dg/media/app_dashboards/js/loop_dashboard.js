        ...
        "oTableTools": {
            ...
            "aButtons": [{
                ...
                "fnClick": function(nButton, oConfig) {
                    ...
                    $('#table2').find('th').removeAttr("class");
                    $('#table2').find('tr').removeAttr("class");
                    $('#table2').find('td').removeAttr("class");
        ...
        "oTableTools": {
            ...
            "aButtons": [{
                    ...
                    "fnClick": function(nButton, oConfig) {
                        ...
                        $('#table3').find('tr').removeAttr("class");
                        $('#table3').find('th').removeAttr("class");
