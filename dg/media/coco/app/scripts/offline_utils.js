...
define([
    ...
    var offline = {
        ...
        save: function (off_model, entity_name, json) {
            ...
            this.check_login_wrapper().done(function () {
                ...
                off_model.save(json, {
                    ...
                    error: function (model, error) {
                        ...
                        cap_entity_name =
                            entity_name.charAt(0).toUpperCase() +
                            entity_name.slice(1);
                        var newerr =
                            cap_entity_name +
                            " with this " +
            ...
            this.check_login_wrapper().done(function () {
                ...
                off_model.destroy({
                    ...
                    error: function (error) {
                        console.log(error);
                        return dfd.reject(
                            "Error destroying object in offline - " +
                                error.srcElement.error.name
                        );
                    },
                });
            });
        ...
        reset_database: function () {
            ...
            request.onerror = function (event) {
                ...
                alert(
                    "Error while resetting database! Refresh the page and try again."
                );
            };
