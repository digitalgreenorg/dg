...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var misc = {
        ...
        inline_upavan_label_dict: {"th#id_label_recall_nonnegotiable": "Did the member recall the knowledge recall points ?", "th#id_member_adopt": "Is the beneficiary practicing the behavior1 ?", "#id_dob": "Date of Home Visit"},
        inline_label_dict: {"th#id_label_recall_nonnegotiable": "Did the member recall the non negotiable ?", "th#id_member_adopt": "Did member adopt the practice? ?", "#id_dob": "Date of Verification"},
