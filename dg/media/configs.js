...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var video_configs = {
        ...
        'labels_हिन्दी': {video:"वीडियो", title: "शीर्षक", video_type: "वीडियो का प्रकार", production_date: "उत्पादन की तिथि", language: "भाषा", benefit: "लाभ",
                            ...
                            approval_date: "स्वीकृति तिथि", youtubeid: "यूट्यूब आईडी", is_dg_video: "यह एक DigitalGreen वीडियो है?", add_row:"खाली पंक्तियाँ जोड़े", sr_no:"क्रम संख्या", non_n:"अति आवश्यक बातें", physically_verifiable:"जाँच करने योग्य"},
        'labels_français': {video:"Vidéos", title: "Titre", video_type: "Type de vidéo", production_date: "Date de production", language: "Langue", benefit: "Bénéfice",
                            ...
                            approval_date: "Date de validation", is_dg_video: "Est-ce un DigitalGreen vidéo?", youtubeid: "Identité Youtube", add_row:"ajouter des lignes", sr_no:"Serie de Numéro", non_n:"Non négociables", physically_verifiable:"Physiquement vérifiable"},
        'labels_English': {video:"Video", title: "Title", video_type: "Video Type", production_date: "Production Date", language: "Language", benefit: "Benefit", village: "Village",
                           ...
                           youtubeid: "Youtube Id", is_dg_video: "Is this a DigitalGreen Video?", add_row:"Add Empty Rows", sr_no:"Sr. No.", non_n:"Non Negotiables", physically_verifiable:"Physically Verifiable"},
    ...
    var screening_configs = {
        ...
        'labels_हिन्दी': {screening:"दिखाए गए वीडियो", date: "विडियो दिखने की तिथि", start_time: "आरंभ करने की तिथि", village: "गाँव", mediator: "मध्यस्थ",
            ...
            del: "हटाओ", sr_no: "क्रम संख्या", person_attended: "सदस्य जिन्होने भाग लिया", is_dg_video: "वीडियो DigitalGreen है?", listened_to_prc: "✓ डाल अगर सदस्य एक ही विषय पर एक पीआरसी की बात सुनी है",
        ...
        'labels_Français': {screening:"Projections", date: "Date de projection", start_time: "Heure de début", village: "Village", mediator: "Disséminateur",
            ...
            del: "effacer", sr_no: "Serie de Numéro", person_attended: "Personne", is_dg_video: "Est DigitalGreen Video ?", listened_to_prc: "Mettez ✓ si le député a écouté un PRC sur le même sujet",
        ...
        'labels_English': {screening:"Screening",date: "Date", start_time: "Start Time", village: "Village", mediator: "Mediator",
            ...
            del: "Delete", sr_no: "Sr. No.", person_attended: "Person", is_dg_video: "Is this a DigitalGreen Screening?", listened_to_prc: "Put ✓ if the member has listened to a PRC on the same topic",
    ...
    var adoption_configs = {
        ...
        'labels_हिन्दी': {adoption:"अपनाए हुए विधि", village: "गाँव", mediator: "मध्यस्थ", video: "वीडियो", groups_attended: "ग्राम संगठन जिन्होने भाग लिया ", person: "सदस्य", del: "हटाओ", sr_no: "क्रम संख्या", date_of_adoption: "अपनाने की तारीख", date_of_verification: "अपनाने के जाँच की तारीख", size_land: "भूमि के आकार , जिस पर अभ्यास को अपनाया", listened_to_prc: "✓ डाल अगर सदस्य एक ही विषय पर एक पीआरसी की बात सुनी है",add_row:"खाली पंक्तियाँ जोड़े"},
        'labels_Français': {adoption:"Adoptions", village: "Village", mediator: "Disséminateur", video: "Vidéo", groups_attended: "Groupes concernés", person: "Personne", del: "effacer", sr_no: "Serie de Numéro", date_of_adoption: "Date d'adoption", date_of_verification: "Date de vérification", size_land: "Taille du terrain sur lequel la pratique adoptée", listened_to_prc: "Mettez ✓ si le député a écouté un PRC sur le même sujet",add_row:"ajouter des lignes"},
        'labels_English': {adoption:"Adoption", village: "Village", mediator: "Mediator", video: "Video", groups_attended: "Groups Attended", person: "Person", del: "Delete", sr_no: "Sr. No.", video: "Video", date_of_adoption: "Date of Adoption", date_of_verification: "Date of Verification", size_land: "Size of land on which the practice adopted", listened_to_prc: "Put ✓ if the member has listened to a PRC on the same topic",add_row: "Add Empty Rows"},
    ...
    var misc = {
        ...
        tweak_fields_based_on_partner: ['umed', 'moa-dg ethiopia'],
