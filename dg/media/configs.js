...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var mediator_configs = {
        ...
        'labels_हिन्दी': {mediator: "मीडियेटर", name: "नाम", district: "जिला", gender: "लिंग", phone_number: "फोन नंबर", assigned_villages: "निरुपित विलेज"},
    ...
    var video_configs = {
        ...
        'labels_हिन्दी': {video:"वीडियो", title: "शीर्षक", video_type: "वीडियो प्रकार", production_date: "उत्पादन की तिथिe", language: "भाषा", benefit: "लाभ",
                            village: "विलेज", production_team: "उत्पादन टोली", category: "श्रेणी", subcategory: "उप श्रेणी", videopractice:"वीडियो प्रैक्टिस",
                            approval_date: "स्वीकृति तिथि", youtubeid: "यू ट्यूब आईडी", add_row:"खाली पंक्तियाँ जोड़े", sr_no:"क्रमांक", non_n:"नों नेगोशबल्स", physically_verifiable:"शारीरिक रूप से निरीक्षण"},
    ...
    var group_configs = {
        ...
        'labels_हिन्दी': {group: "ग्रूप्स", name: "नाम", village: "विलेज", person_name: "पर्सन का नाम", father_name: "पिता का नाम",
                           age: "आयु", gender: "लिंग", phone_no: "फोन नंबर", add_row:"खाली पंक्तियाँ जोड़े"},
    ...
    var screening_configs = {
        ...
        'labels_हिन्दी': {screening:"सक्रीनिंग्स", date: "तारीख", start_time: "शुरूवात का समय", village: "विलेज", mediator: "मीडियेटर",
            videos_screened: "वीडियोस सक्रींड", groups_attended: "ग्रूप्स अटेंडेड", person: "पर्सन", questions_asked: "पूछे गये सवाल",
            del: "डिलीट", sr_no: "क्रमांक", person_attended: "पर्सन"},
    ...
    var adoption_configs = {
        ...
        'labels_हिन्दी': {adoption:"अडॉप्षन्", village: "विलेज", mediator: "मीडियेटर", video: "वीडियो", groups_attended: "ग्रूप्स अटेंडेड", person: "पर्सन", del: "डिलीट", sr_no: "क्रमांक", date_of_adoption: "अडॉप्षन की तिथि", date_of_verification: "वेरिफिकेशन की तिथि"},
    ...
    var person_configs = {
        ...
        'labels_हिन्दी': {person:"पर्सन", name:"नाम", father_name:"पिता का नाम", village: "विलेज", gender:"लिंग", age:"आयु", phone_no:"फोन नंबर",group:"ग्रूप"},
    ...
    var misc = {
        ...
        meta_हिन्दी: {stop: "रोकें",close:"बंद करे", sync:"सिंक", save: "सेव करें", help:"हेल्प", logout:"लोगौट", download:"डाउनलोडिंग...", upload:"अपलोडिंग...",inprogress:"इन प्रोग्रेस", done:"समाप्त", edit:"एडिट",
                       ...
                       error: "त्रुटि!!", upload_error:"इंटरनेट कनेक्टिविटी खो दिया है। कृपया कुछ देर बाद प्रयास करें!",copy_clipboard:"क्लिपबोर्ड पर कॉपी करें", excel_download:"एक्सेल में डाउनलोड करें", search: "खोजें: ", enteries:"एंट्रीयान: ", total_enteries:"कुल एंट्रीयान: ",
                       next:"अगला", previous:"पिछला", list_page_help:"एकाधिक स्तंभ छंटाई, प्रेस और के लिए है, जबकि प्रत्येक स्तंभ छँटाई शिफ्ट कुंजी पकड़।"},
