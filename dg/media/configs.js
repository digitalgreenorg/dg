...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var video_configs = {
        ...
        'list_elements_English': [{'header':'ID','element':'online_id'},{'element':'title'},{'header':'Village','element':'village.village_name'},{'header':'Production Date','element':'production_date'}, {'header':'Category','element':'category.category_name'}],
    ...
    var screening_configs = {
        ...
        'text_to_select_display_hack_field_array': ['frontline_worker_present', 'type_of_venue', 'type_of_video', 'meeting_topics'],
