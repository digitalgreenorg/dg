...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var person_configs = {
        ...
        'labels_हिन्दी': {person:"सदस्य", name:"नाम", father_name:"पिता/पति का नाम", village: "गाँव", gender:"लिंग", age:"आयु", phone_no:"फ़ोन नंबर",group:"ग्राम संगठन का नाम", is_modelfarmer: "इस व्यक्ति को एक मॉडल किसान है?"},
        'labels_Français': {person:"Personnes", name:"Nom de la personne", father_name:"Nom du père", village: "Nom du village", gender:"Genre", age:"Age", phone_no:"Numéro de téléphone",group:"Groupe", is_modelfarmer: "Cette personne est un agriculteur de modèle?"},
        'labels_English': {person: "Person", name:"Name", father_name:"Father Name", village: "Village", gender:"Gender", age:"Age", phone_no:"Phone Number",group:"Group", is_modelfarmer: "Is this person a model farmer?"},
