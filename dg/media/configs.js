...
//     TODO: maybe instead of relying on users to use templating lang we should fill the rows ourselves in js code, like we are doing in form!
    ...
    var screening_configs = {
        ...
        'labels_हिन्दी': {screening:"दिखाए गए वीडियो", date: "विडियो दिखने की तिथि", start_time: "आरंभ करने की तिथि", village: "गाँव", mediator: "मध्यस्थ",
            ...
            del: "हटाओ", sr_no: "क्रम संख्या", person_attended: "सदस्य जिन्होने भाग लिया", form_type: 'वर्ग', age: 'आयु', gender: 'लिंग',
            health_provider_present: "स्वास्थ्य प्रदाता वर्तमान", csp_name: 'CSP Name', frontline_worker_present: 'Frontline worker present?',
        ...
        'labels_Français': {screening:"Projections", date: "Date de projection", start_time: "Heure de début", village: "Village", mediator: "Disséminateur",
            ...
            category: "Catégorie", health_provider_present: "Prestataire de santé présent", csp_name: 'CSP Name',
        ...
        'labels_English': {screening:"Screening",date: "Date", start_time: "Start Time", village: "Village", mediator: "mediator",
            ...
            category: "Category", health_provider_present: "Health Provider Present", csp_name: 'CSP Name',
            frontline_worker_present: 'Frontline worker present?', type_of_venue: "Type of Venue"},
        ...
        'text_to_select_display_hack_field_array': ['frontline_worker_present', 'type_of_venue'],
