...
define(function(require) {
    ...
    var CollectionDropDownController = Controller.extend({
        ...
        afterCollectionAdd: function(){
            var references = this._references;
            var url = "/videos/discover" +"/"+ references.$partnerList.find("option:selected").text() +"/"+ references.$countryList.val() +"/"+ references.$stateList.val() +"/"+ references.$langList.val() +"/"+ references.$collectionTitle.val()
