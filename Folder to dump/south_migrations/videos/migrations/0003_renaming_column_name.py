...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'language.name' to 'language.language_name'
        db.rename_column(u'videos_language', 'name', 'language_name')

    def backwards(self, orm):
        # Renaming field 'language.language_name' to 'language.name'
        db.rename_column(u'videos_language', 'language_name', 'name')
