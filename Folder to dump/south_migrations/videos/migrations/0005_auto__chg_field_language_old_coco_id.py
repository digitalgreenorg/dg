...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Language.old_coco_id'
        db.alter_column(u'videos_language', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Language.old_coco_id'
        db.alter_column(u'videos_language', 'old_coco_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))
