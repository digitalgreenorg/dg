...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JSLPS_NN'
        db.create_table(u'videos_jslps_nn', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_jslps_nn_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'videos_jslps_nn_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nn_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('non_negotiable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.NonNegotiable'], null=True, blank=True)),
        ))
        db.send_create_signal(u'videos', ['JSLPS_NN'])
    ...
    def backwards(self, orm):
        # Deleting model 'JSLPS_NN'
        db.delete_table(u'videos_jslps_nn')
    ...
    models = {
        ...
        u'videos.jslps_nn': {
            'Meta': {'object_name': 'JSLPS_NN'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nn_code': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'non_negotiable': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['videos.NonNegotiable']", 'null': 'True', 'blank': 'True'}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'videos_jslps_nn_created'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_modified': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'videos_jslps_nn_related_modified'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
