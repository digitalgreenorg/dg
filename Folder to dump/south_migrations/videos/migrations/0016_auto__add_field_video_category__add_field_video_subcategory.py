...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'videos_video', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Category'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.subcategory'
        db.add_column(u'videos_video', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.category'
        db.delete_column(u'videos_video', 'category_id')

        # Deleting field 'Video.subcategory'
        db.delete_column(u'videos_video', 'subcategory_id')
