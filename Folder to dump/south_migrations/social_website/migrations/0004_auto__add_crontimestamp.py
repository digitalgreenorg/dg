...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CronTimestamp'
        db.create_table('social_website_crontimestamp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 5, 0, 0))),
        ))
        db.send_create_signal('social_website', ['CronTimestamp'])
    ...
    models = {
        ...
        'social_website.crontimestamp': {
            ...
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
