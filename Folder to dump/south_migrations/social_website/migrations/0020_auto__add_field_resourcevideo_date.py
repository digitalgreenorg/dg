...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceVideo.date'
        db.add_column(u'social_website_resourcevideo', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 4, 22, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceVideo.date'
        db.delete_column(u'social_website_resourcevideo', 'date')
    ...
    models = {
        ...
        u'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 22, 0, 0)'}),
        ...
        u'social_website.crontimestamp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 22, 0, 0)'}),
