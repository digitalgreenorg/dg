...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_website_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'VideoLike.user'
        db.alter_column(u'social_website_videolike', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Deleting model 'UserProfile'
        db.delete_table(u'social_website_userprofile')

    def backwards(self, orm):
        # Adding model 'UserProfile'
        db.create_table(u'social_website_userprofile', (
        ...
        db.send_create_signal(u'social_website', ['UserProfile'])


        # Changing field 'Comment.user'
        db.alter_column(u'social_website_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_website.UserProfile'], null=True))

        # Changing field 'VideoLike.user'
        db.alter_column(u'social_website_videolike', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_website.UserProfile']))
