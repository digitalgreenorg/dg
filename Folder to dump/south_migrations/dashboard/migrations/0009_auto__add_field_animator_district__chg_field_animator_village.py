...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Animator.district'
        db.add_column(u'animator', 'district',
                      self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.District'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Animator.village'
        db.alter_column(u'animator', 'home_village_id', self.gf('dashboard.fields.related.BigForeignKey')(to=orm['dashboard.Village'], null=True, db_column='home_village_id'))

    def backwards(self, orm):
        # Deleting field 'Animator.district'
        db.delete_column(u'animator', 'district_id')


        # Changing field 'Animator.village'
        db.alter_column(u'animator', 'home_village_id', self.gf('dashboard.fields.related.BigForeignKey')(default=0, to=orm['dashboard.Village'], db_column='home_village_id'))
