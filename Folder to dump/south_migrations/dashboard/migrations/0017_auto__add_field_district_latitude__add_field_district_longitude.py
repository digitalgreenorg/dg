...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.latitude'
        db.add_column(u'district', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=31, decimal_places=28, blank=True),
                      keep_default=False)

        # Adding field 'District.longitude'
        db.add_column(u'district', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=32, decimal_places=28, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.latitude'
        db.delete_column(u'district', 'latitude')

        # Deleting field 'District.longitude'
        db.delete_column(u'district', 'longitude')
