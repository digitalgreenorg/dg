...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dimagi_xmlsubmission', 'modification_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'XMLSubmission.modification_time'
        db.alter_column(u'dimagi_xmlsubmission', 'modification_time', self.gf('django.db.models.fields.DateTimeField')())
