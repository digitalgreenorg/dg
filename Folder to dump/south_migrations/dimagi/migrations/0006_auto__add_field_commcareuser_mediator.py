...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommCareUser.mediator'
        db.add_column(u'dimagi_commcareuser', 'mediator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Animator'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommCareUser.mediator'
        db.delete_column(u'dimagi_commcareuser', 'mediator_id')
    ...
    models = {
        ...
        u'coco.cocouser': {
            ...
            'old_coco_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'user_created': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'coco_cocouser_created'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_modified': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'coco_cocouser_related_modified'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['videos.Video']", 'symmetrical': 'False'}),
            'villages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['geographies.Village']", 'symmetrical': 'False'})
        },
        ...
        u'dimagi.commcareproject': {
            ...
            'group_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'group_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dimagi.commcareuser': {
            ...
            'coco_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coco.CocoUser']"}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mediator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Animator']", 'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dimagi.CommCareProject']"}),
