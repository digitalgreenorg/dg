...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JSLPS_PMA.pma_c'
        db.delete_column(u'activities_jslps_pma', 'pma_c')

        # Adding field 'JSLPS_PMA.pma_code'
        db.add_column(u'activities_jslps_pma', 'pma_code',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'JSLPS_Screening.sc'
        db.delete_column(u'activities_jslps_screening', 'sc')

        # Adding field 'JSLPS_Screening.screenig_code'
        db.add_column(u'activities_jslps_screening', 'screenig_code',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JSLPS_PMA.pma_c'
        db.add_column(u'activities_jslps_pma', 'pma_c',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'JSLPS_PMA.pma_code'
        db.delete_column(u'activities_jslps_pma', 'pma_code')

        # Adding field 'JSLPS_Screening.sc'
        db.add_column(u'activities_jslps_screening', 'sc',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'JSLPS_Screening.screenig_code'
        db.delete_column(u'activities_jslps_screening', 'screenig_code')
