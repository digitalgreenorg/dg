...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'activities_jslps_pma', (
            ...
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'activities_jslps_pma_created', null=True, to=orm['auth.User'], blank=True)),
            ('pma_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'activities_jslps_pma_related_modified', null=True, to=orm['auth.User'], blank=True)),
