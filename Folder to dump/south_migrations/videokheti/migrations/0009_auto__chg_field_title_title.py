...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Title.title'
        db.alter_column(u'videokheti_title', 'title', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Title.title'
        db.alter_column(u'videokheti_title', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'videokheti.videocomment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
