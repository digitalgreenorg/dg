...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        GeographyCountry = orm['geographies.Country']
        GeographyCountry.objects.bulk_create([GeographyCountry(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
                                                               old_coco_id=x.id, country_name=x.country_name, start_date=x.start_date) for x in orm['dashboard.Country'].objects.all()])

        GeographyRegion = orm['geographies.Region']
        GeographyRegion.objects.bulk_create([GeographyRegion(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
                                                             old_coco_id=x.id, region_name=x.region_name, start_date=x.start_date) for x in orm['dashboard.Region'].objects.all()])

        GeographyState = orm['geographies.State']
        GeographyState.objects.bulk_create([GeographyState(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
                                                           old_coco_id=x.id, state_name=x.state_name, region=GeographyRegion.objects.get(old_coco_id=x.region_id), country=GeographyCountry.objects.get(old_coco_id=x.country_id), start_date=x.start_date) for x in orm['dashboard.State'].objects.all()])
        ...
        mBlock.objects.bulk_create([mBlock(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
                                           old_coco_id=x.id, block_name=x.block_name, start_date=x.start_date, district=mDistrict.objects.get(old_coco_id=x.district_id)) for x in orm['dashboard.Block'].objects.all()])

        mVillage = orm['geographies.Village']
        mVillage.objects.bulk_create([mVillage(user_created_id=x.user_created_id, time_created=x.time_created, user_modified_id=x.user_modified_id, time_modified=x.time_modified,
        ...
        db.create_index('geographies_village', ['old_coco_id'])
        print "index created for villages"
    ...
    complete_apps = ['dashboard', 'geographies']
    symmetrical = True
